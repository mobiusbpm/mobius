...
import mobius.app.rest.service.BaseSpringRestTestCase;
...
public class AppDefinitionCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetAppDefinitions() throws Exception {
        ...
        try {
            AppDeployment firstDeployment = repositoryService.createDeployment().name("Deployment 1").addClasspathResource("mobius/app/rest/service/api/repository/oneApp.app").deploy();
            ...
            AppDeployment secondDeployment = repositoryService.createDeployment().name("Deployment 2").addClasspathResource("mobius/app/rest/service/api/repository/oneApp.app").deploy();
            
            AppDeployment thirdDeployment = repositoryService.createDeployment().name("Deployment 3").addClasspathResource("mobius/app/rest/service/api/repository/secondApp.app").deploy();
            ...
            url = baseUrl + "?resourceName=mobius/app/rest/service/api/repository/secondApp.app";
            assertResultsPresentInDataResponse(url, secondApp.getId());
