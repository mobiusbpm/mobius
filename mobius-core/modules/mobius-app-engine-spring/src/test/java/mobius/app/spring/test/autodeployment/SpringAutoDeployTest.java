...
package mobius.app.spring.test.autodeployment;
...
public class SpringAutoDeployTest {
    ...
    protected static final String CTX_PATH = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-context.xml";
    protected static final String CTX_NO_DROP_PATH = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-no-drop-context.xml";
    protected static final String CTX_CREATE_DROP_CLEAN_DB = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-create-drop-clean-db-context.xml";
    protected static final String CTX_DEPLOYMENT_MODE_DEFAULT = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-deploymentmode-default-context.xml";
    protected static final String CTX_DEPLOYMENT_MODE_SINGLE_RESOURCE = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-deploymentmode-single-resource-context.xml";
    protected static final String CTX_DEPLOYMENT_MODE_RESOURCE_PARENT_FOLDER = "mobius/app/spring/test/autodeployment/SpringAutoDeployTest-deploymentmode-resource-parent-folder-context.xml";
    ...
    public void testBasicSpringIntegration() {
        createAppContext("mobius/app/spring/test/autodeployment/SpringAutoDeployTest-context.xml");
    ...
    public void testResourceRedeploymentAfterAppDefinitionChange() throws Exception {
        ...
        String filePath = "mobius/app/spring/test/autodeployment/simple.app";
