...
import mobius.app.engine.impl.persistence.entity.AppResourceEntity;
...
public class TableDataManagerImpl implements TableDataManager {
    ...
    public Map<String, Long> getTableCount() {
        ...
        for (String table : getTablesPresentInDatabase()) {
            counts.put(table, (Long) CommandContextUtil
					.getDbSqlSession().selectOne("mobius.engine.impl.TableData.selectTableCount", table));
        }
        return counts;
    }
