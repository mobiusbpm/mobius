...
package mobius.app.engine.test;
...
public class FlowableAppRule implements TestRule {
    ...
    protected void starting(Description description) {
        ...
        try {
            deploymentId = AppTestHelper
					.annotationDeploymentSetUp(appEngine, Class.forName(description.getClassName()), description.getMethodName());
