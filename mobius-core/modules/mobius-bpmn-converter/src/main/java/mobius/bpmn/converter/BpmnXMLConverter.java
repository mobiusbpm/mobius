...
import mobius.bpmn.converter.alfresco.AlfrescoStartEventXMLConverter;
import mobius.bpmn.converter.alfresco.AlfrescoUserTaskXMLConverter;
import mobius.bpmn.converter.child.DocumentationParser;
import mobius.bpmn.converter.child.IOSpecificationParser;
import mobius.bpmn.converter.child.MultiInstanceParser;
import mobius.bpmn.converter.export.BPMNDIExport;
import mobius.bpmn.converter.export.CollaborationExport;
import mobius.bpmn.converter.export.DataStoreExport;
import mobius.bpmn.converter.export.DefinitionsRootExport;
import mobius.bpmn.converter.export.EscalationDefinitionExport;
import mobius.bpmn.converter.export.FlowableListenerExport;
import mobius.bpmn.converter.export.MultiInstanceExport;
import mobius.bpmn.converter.export.ProcessExport;
import mobius.bpmn.converter.export.SignalAndMessageDefinitionExport;
import mobius.bpmn.converter.parser.BpmnEdgeParser;
import mobius.bpmn.converter.parser.BpmnShapeParser;
import mobius.bpmn.converter.parser.DataStoreParser;
import mobius.bpmn.converter.parser.DefinitionsParser;
import mobius.bpmn.converter.parser.ExtensionElementsParser;
import mobius.bpmn.converter.parser.ImportParser;
import mobius.bpmn.converter.parser.InterfaceParser;
import mobius.bpmn.converter.parser.ItemDefinitionParser;
import mobius.bpmn.converter.parser.LaneParser;
import mobius.bpmn.converter.parser.MessageFlowParser;
import mobius.bpmn.converter.parser.MessageParser;
import mobius.bpmn.converter.parser.ParticipantParser;
import mobius.bpmn.converter.parser.PotentialStarterParser;
import mobius.bpmn.converter.parser.ProcessParser;
import mobius.bpmn.converter.parser.ResourceParser;
import mobius.bpmn.converter.parser.SignalParser;
import mobius.bpmn.converter.parser.SubProcessParser;
...
public class BpmnXMLConverter implements BpmnXMLConstants {
    ...
    protected static final String BPMN_XSD = "mobius/parser/BPMN20.xsd";
