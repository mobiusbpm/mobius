 ...
 */
package mobius.bpmn.converter.util;
...
import mobius.bpmn.converter.child.BaseChildElementParser;
import mobius.bpmn.converter.child.CancelEventDefinitionParser;
import mobius.bpmn.converter.child.CompensateEventDefinitionParser;
import mobius.bpmn.converter.child.ConditionExpressionParser;
import mobius.bpmn.converter.child.ConditionParser;
import mobius.bpmn.converter.child.ConditionalEventDefinitionParser;
import mobius.bpmn.converter.child.DataInputAssociationParser;
import mobius.bpmn.converter.child.DataOutputAssociationParser;
import mobius.bpmn.converter.child.DataStateParser;
import mobius.bpmn.converter.child.DocumentationParser;
import mobius.bpmn.converter.child.ErrorEventDefinitionParser;
import mobius.bpmn.converter.child.EscalationEventDefinitionParser;
import mobius.bpmn.converter.child.ExecutionListenerParser;
import mobius.bpmn.converter.child.FieldExtensionParser;
import mobius.bpmn.converter.child.FlowNodeRefParser;
import mobius.bpmn.converter.child.FlowableEventListenerParser;
import mobius.bpmn.converter.child.FlowableFailedjobRetryParser;
import mobius.bpmn.converter.child.FlowableHttpRequestHandlerParser;
import mobius.bpmn.converter.child.FlowableHttpResponseHandlerParser;
import mobius.bpmn.converter.child.FlowableMapExceptionParser;
import mobius.bpmn.converter.child.FormPropertyParser;
import mobius.bpmn.converter.child.IOSpecificationParser;
import mobius.bpmn.converter.child.MessageEventDefinitionParser;
import mobius.bpmn.converter.child.MultiInstanceParser;
import mobius.bpmn.converter.child.SignalEventDefinitionParser;
import mobius.bpmn.converter.child.TaskListenerParser;
import mobius.bpmn.converter.child.TerminateEventDefinitionParser;
import mobius.bpmn.converter.child.TimeCycleParser;
import mobius.bpmn.converter.child.TimeDateParser;
import mobius.bpmn.converter.child.TimeDurationParser;
import mobius.bpmn.converter.child.TimerEventDefinitionParser;
import mobius.bpmn.model.BaseElement;
import mobius.bpmn.model.BpmnModel;
import mobius.bpmn.model.ExtensionAttribute;
