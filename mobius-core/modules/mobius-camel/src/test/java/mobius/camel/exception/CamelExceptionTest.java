...
package mobius.camel.exception;
...
import mobius.camel.exception.tools.ExceptionServiceMock;
import mobius.camel.exception.tools.NoExceptionServiceMock;
import mobius.camel.exception.tools.ThrowBpmnExceptionBean;
...
public class CamelExceptionTest extends SpringFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/camel/exception/bpmnExceptionInRouteSynchronous.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/camel/exception/bpmnExceptionInRouteAsynchronous.bpmn20.xml" })
