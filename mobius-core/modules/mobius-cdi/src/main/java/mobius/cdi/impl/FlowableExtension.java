...
import mobius.cdi.annotation.BusinessProcessScoped;
import mobius.cdi.impl.context.BusinessProcessContext;
...
import mobius.cdi.spi.ProcessEngineLookup;
...
public class FlowableExtension implements Extension {
    ...
    protected ProcessEngine lookupProcessEngine(BeanManager beanManager) {
        ...
        if (processEngineLookup == null) {
            throw new FlowableException("Could not find an implementation of the mobius.cdi.spi.ProcessEngineLookup service " + "returning a non-null processEngine. Giving up.");
        }
