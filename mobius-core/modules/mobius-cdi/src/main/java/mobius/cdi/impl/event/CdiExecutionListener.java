...
import mobius.cdi.annotation.event.EndActivityLiteral;
import mobius.cdi.annotation.event.StartActivityLiteral;
import mobius.cdi.annotation.event.TakeTransitionLiteral;
...
public class CdiExecutionListener implements ExecutionListener, Serializable {
    ...
    protected BusinessProcessEvent createEvent(DelegateExecution execution) {
        ...
        ProcessEngineConfiguration engineConfiguration = mobius.engine.impl.context.Context.getProcessEngineConfiguration();
