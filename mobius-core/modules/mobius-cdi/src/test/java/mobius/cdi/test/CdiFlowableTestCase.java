...
import mobius.cdi.test.util.ProcessEngineLookupForTestsuite;
...
public abstract class CdiFlowableTestCase {
    ...
    public static JavaArchive createDeployment() {
        ...
        return ShrinkWrap.create(JavaArchive.class).addPackages(true, "mobius.cdi").addAsManifestResource("META-INF/beans.xml", "beans.xml");
    }
