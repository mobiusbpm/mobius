...
public class SignalEventTest extends CdiFlowableTestCase {
    ...
    @Test
    @Deployment(resources = {"mobius/cdi/test/bpmn/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml",
            "mobius/cdi/test/bpmn/SignalEventTests.throwAlertSignalWithDelegate.bpmn20.xml"})
