 ...
 */
package mobius.cdi.test.impl.beans;

import mobius.cdi.annotation.CompleteTask;
import mobius.cdi.annotation.ProcessVariable;
import mobius.cdi.annotation.StartProcess;
