 ...
 */
package mobius.cdi.test.impl.el;

import static org.junit.Assert.assertEquals;

import mobius.cdi.test.CdiFlowableTestCase;
import mobius.cdi.test.impl.beans.MessageBean;
...
public class ElTest extends CdiFlowableTestCase {
    ...
    // @Test
    // @Deployment(resources="mobius/cdi/test/impl/el/ElTest.testInvalidExpression.bpmn20.xml")
