 ...
 */
package mobius.cdi.test.impl.event;

import static org.junit.Assert.assertEquals;

import mobius.cdi.test.CdiFlowableTestCase;
...
public class EventNotificationTest extends CdiFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml", "mobius/cdi/test/impl/event/EventNotificationTest.process2.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/cdi/test/impl/event/TaskEventNotificationTest.process3.bpmn20.xml" })
