...
import mobius.cdi.annotation.event.AssignTask;
import mobius.cdi.annotation.event.BusinessProcess;
import mobius.cdi.annotation.event.CompleteTask;
import mobius.cdi.annotation.event.CreateTask;
import mobius.cdi.annotation.event.DeleteTask;
import mobius.cdi.annotation.event.EndActivity;
import mobius.cdi.annotation.event.StartActivity;
import mobius.cdi.annotation.event.TakeTransition;
