 ...
 */
package mobius.cdi.test.impl.util;
...
import mobius.cdi.impl.util.FlowableServices;
import mobius.cdi.impl.util.ProgrammaticBeanLookup;
import mobius.cdi.test.impl.beans.SpecializedTestBean;
...
public class ProgrammaticBeanLookupTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class).addClass(ProgrammaticBeanLookup.class).addClass(FlowableServices.class).addAsManifestResource("mobius/cdi/test/impl/util/beans.xml", "beans.xml");
    }
    ...
    public static JavaArchive createDeploymentWithAlternative() {
        return ShrinkWrap.create(JavaArchive.class).addClass(ProgrammaticBeanLookup.class).addClass(FlowableServices.class).addClass(AlternativeTestBean.class)
                .addAsManifestResource("mobius/cdi/test/impl/util/beansWithAlternative.xml", "beans.xml");
    }
    ...
    public static JavaArchive createDeploymentWithSpecialization() {
        return ShrinkWrap.create(JavaArchive.class).addClass(ProgrammaticBeanLookup.class).addClass(FlowableServices.class).addClass(SpecializedTestBean.class)
                .addAsManifestResource("mobius/cdi/test/impl/util/beans.xml", "beans.xml");
    }
