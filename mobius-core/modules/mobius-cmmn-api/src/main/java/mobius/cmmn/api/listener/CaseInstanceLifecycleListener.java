...
public interface CaseInstanceLifecycleListener {
    ...
    /**
     * @return The type a case instance is changing from, use a value from {@link mobius.cmmn.api.runtime.CaseInstanceState}.
    ...
    /**
     * @return The type a case instance is changing to, use a value from {@link mobius.cmmn.api.runtime.CaseInstanceState}.
     *         This listener will only receive elements where the state changing from this value to another one.
     *         Return null or the empty String to listen to any state.
     */
