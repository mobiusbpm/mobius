 ...
 */
package mobius.cmmn.api.listener;
...
public interface PlanItemInstanceLifecycleListener {
    ...
    /**
     * @return The type a plan item instance is changing from, use a value from {@link mobius.cmmn.api.runtime.PlanItemInstanceState}.
    ...
    /**
     * @return The type a plan item instance is changing to, use a value from {@link mobius.cmmn.api.runtime.PlanItemInstanceState}.
     *         This listener will only receive elements where the state changing from this value to another one.
     *         Return null or the empty String to listen to any state.
     */
