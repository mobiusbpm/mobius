...
import mobius.cmmn.model.*;
import mobius.cmmn.model.Process;
import org.apache.commons.lang3.StringUtils;
import mobius.cmmn.converter.exception.XMLException;
import mobius.cmmn.converter.export.CaseExport;
import mobius.cmmn.converter.export.CmmnDIExport;
import mobius.cmmn.converter.export.DefinitionsRootExport;
import mobius.cmmn.converter.export.StageExport;
import mobius.cmmn.converter.util.PlanItemDependencyUtil;
import mobius.cmmn.model.DecisionTask;
import mobius.cmmn.model.HasEntryCriteria;
...
public class CmmnXmlConverter implements CmmnXmlConstants {
    ...
    protected static final String XSD_LOCATION = "mobius.impl.cmmn.parser/CMMN11.xsd";
        ...
        for (PlanItem planItem : planFragment.getPlanItems()) {
            ...
            if (planItemDefinition instanceof PlanFragment) {
                ...
                if (processTask.getProcessRef() != null) {
                    Process process = cmmnModel.getProcessById(processTask.getProcessRef());
                    if (process != null) {
                ...
                if (decisionTask.getDecisionRef() != null) {
                    Decision decision = cmmnModel.getDecisionById(decisionTask.getDecisionRef());
                    if (decision != null) {
