 ...
 */
package mobius.cmmn.engine.configurator.impl.process;
...
import mobius.engine.impl.cmd.TriggerCaseTaskCmd;
import mobius.engine.impl.persistence.entity.BpmnEngineEntityConstants;
...
public class DefaultProcessInstanceService implements ProcessInstanceService {
    ...
    public List<IOParameter> getOutputParametersOfCaseTask(String executionId) {
        ...
        List<mobius.bpmn.model.IOParameter> parameters = caseServiceTask.getOutParameters();
        for (mobius.bpmn.model.IOParameter ioParameter : parameters) {
