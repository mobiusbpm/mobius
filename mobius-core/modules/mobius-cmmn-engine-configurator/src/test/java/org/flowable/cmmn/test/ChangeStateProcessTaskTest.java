...
public class ChangeStateProcessTaskTest extends AbstractProcessEngineIntegrationTest {
    ...
    @Test
    @CmmnDeployment(resources = {"mobius/cmmn/test/ChangeStateProcessTaskTest.testActivateProcessTask.cmmn"})
    ...
    @Test
    @CmmnDeployment(resources = {"mobius/cmmn/test/ChangeStateProcessTaskTest.testActivateProcessTaskInStage.cmmn"})
    ...
    @Test
    @CmmnDeployment(resources = {"mobius/cmmn/test/twoTasksWithProcessTask.cmmn"})
