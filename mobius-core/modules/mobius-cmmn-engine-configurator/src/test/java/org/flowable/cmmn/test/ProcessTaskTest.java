...
import mobius.cmmn.api.runtime.*;
...
public class ProcessTaskTest extends mobius.cmmn.test.AbstractProcessEngineIntegrationTest {
    ...
    public void deployOneTaskProcess() {
        if (processEngineRepositoryService.createDeploymentQuery().count() == 0) {
            processEngineRepositoryService.createDeployment().addClasspathResource("mobius/cmmn/test/oneTaskProcess.bpmn20.xml").deploy();
        }
    }
    ...
    public void testOneCallActivityProcessBlocking() {
        Deployment deployment = processEngine.getRepositoryService().createDeployment()
                .addClasspathResource("mobius/cmmn/test/oneCallActivityProcess.bpmn20.xml")
                .addClasspathResource("mobius/cmmn/test/oneTaskProcess.bpmn20.xml")
                .deploy();
    ...
    resources = "mobius/cmmn/test/ProcessTaskTest.testOneTaskProcessBlocking.cmmn")
    ...
    @Test
    @CmmnDeployment(resources = "mobius/cmmn/test/ProcessTaskTest.testOneTaskProcessBlocking.cmmn")
    public void testTwoTaskProcessBlocking() {
        try {
            ...
            processEngineRepositoryService.createDeployment().
                    addClasspathResource("mobius/cmmn/test/twoTaskProcess.bpmn20.xml").
                    deploy();
    ...
    public void testProcessTaskWithSkipExpressions() {
        processEngineRepositoryService.createDeployment().addClasspathResource("mobius/cmmn/test/processWithSkipExpressions.bpmn20.xml").deploy();
    ...
    public void testProcessTaskWithInclusiveGateway() {
        Deployment deployment = processEngineRepositoryService.createDeployment().addClasspathResource("mobius/cmmn/test/processWithInclusiveGateway.bpmn20.xml").deploy();
        try {
    ...
    @CmmnDeployment(resources = {
        "mobius/cmmn/test/ProcessTaskTest.testParentStageTerminatedBeforeProcessStarted.cmmn",
        "mobius/cmmn/test/oneTaskProcess.bpmn20.xml"
    })
    ...
    @Test
    @CmmnDeployment(
        resources = {"mobius/cmmn/test/ProcessTaskTest.testOneTaskProcessFallbackToDefaultTenant.cmmn"},
        tenantId = "flowable"
    )
    ...
    @Test
    @CmmnDeployment(
        resources = {"mobius/cmmn/test/ProcessTaskTest.testOneTaskProcessNonBlocking.cmmn"},
        tenantId = "someTenant"
    )
    ...
    @Test
    @CmmnDeployment(
        resources = {"mobius/cmmn/test/ProcessTaskTest.testOneTaskProcessFallbackToDefaultTenantFalse.cmmn"},
        tenantId = "flowable"
    )
    ...
    public void testChangeActiveStages() {
        ...
        Deployment deployment = this.processEngineRepositoryService.createDeployment().
            addClasspathResource("mobius/cmmn/test/emptyProcess.bpmn20.xml").
            deploy();
