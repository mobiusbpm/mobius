 ...
 */
package mobius.cmmn.test.validate;
...
import mobius.cmmn.test.AbstractProcessEngineIntegrationTest;
import mobius.form.api.FormDefinition;
import mobius.form.api.FormRepositoryService;
import mobius.form.engine.FlowableFormValidationException;
...
public class CaseWithFormTest extends AbstractProcessEngineIntegrationTest {
    ...
    public static final String ONE_TASK_CASE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        ...
        + "                <extensionElements>\n"
        + "                    <flowable:taskListener event=\"create\" class=\"mobius.cmmn.test.validate.SideEffectTaskListener\"></flowable:taskListener>\n"
        + "                    <flowable:taskListener event=\"complete\" class=\"mobius.cmmn.test.validate.SideEffectTaskListener\"></flowable:taskListener>\n"
        + "                </extensionElements>\n"
        + "            </humanTask>\n"
        + "\n"
        + "        </casePlanModel>\n"
    ...
    public void initialize() {
        ...
        formRepositoryService.createDeployment().
            addClasspathResource("mobius/cmmn/test/simple.form").
            deploy();
        ...
        cmmnEngineConfiguration.getCmmnRepositoryService().createDeployment().
            addString("mobius/cmmn/test/oneTasksCaseWithForm.cmmn", ONE_TASK_CASE.
