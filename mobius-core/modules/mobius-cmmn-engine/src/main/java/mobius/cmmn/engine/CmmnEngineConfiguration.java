...
import mobius.cmmn.engine.impl.*;
import mobius.cmmn.engine.impl.agenda.CmmnEngineAgendaFactory;
import mobius.cmmn.engine.impl.agenda.CmmnEngineAgendaSessionFactory;
import mobius.cmmn.engine.impl.agenda.DefaultCmmnEngineAgendaFactory;
import mobius.cmmn.engine.impl.callback.ChildBpmnCaseInstanceStateChangeCallback;
import mobius.cmmn.engine.impl.callback.ChildCaseInstanceStateChangeCallback;
import mobius.cmmn.engine.impl.callback.DefaultInternalCmmnJobManager;
import mobius.cmmn.engine.impl.cfg.DefaultTaskAssignmentManager;
import mobius.cmmn.engine.impl.cfg.DelegateExpressionFieldInjectionMode;
import mobius.cmmn.engine.impl.cfg.StandaloneInMemCmmnEngineConfiguration;
import mobius.cmmn.engine.impl.cmd.JobRetryCmd;
import mobius.cmmn.engine.impl.cmd.SchemaOperationsCmmnEngineBuild;
import mobius.cmmn.engine.impl.db.CmmnDbSchemaManager;
import mobius.cmmn.engine.impl.db.EntityDependencyOrder;
import mobius.cmmn.engine.impl.delegate.CmmnClassDelegateFactory;
import mobius.cmmn.engine.impl.delegate.DefaultCmmnClassDelegateFactory;
import mobius.cmmn.engine.impl.deployer.CaseDefinitionDiagramHelper;
import mobius.cmmn.engine.impl.deployer.CmmnDeployer;
import mobius.cmmn.engine.impl.deployer.CmmnDeploymentManager;
import mobius.cmmn.engine.impl.el.CmmnExpressionManager;
import mobius.cmmn.engine.impl.form.DefaultFormFieldHandler;
import mobius.cmmn.engine.impl.function.IsStageCompletableExpressionFunction;
import mobius.cmmn.engine.impl.history.CmmnHistoryManager;
import mobius.cmmn.engine.impl.history.CmmnHistoryTaskManager;
import mobius.cmmn.engine.impl.history.CmmnHistoryVariableManager;
import mobius.cmmn.engine.impl.history.DefaultCmmnHistoryManager;
import mobius.cmmn.engine.impl.history.async.AsyncCmmnHistoryManager;
import mobius.cmmn.engine.impl.history.async.CmmnAsyncHistoryConstants;
import mobius.cmmn.engine.impl.history.async.json.transformer.*;
import mobius.cmmn.engine.impl.idm.DefaultCandidateManager;
import mobius.cmmn.engine.impl.interceptor.CmmnCommandInvoker;
import mobius.cmmn.engine.impl.interceptor.DefaultCmmnIdentityLinkInterceptor;
import mobius.cmmn.engine.impl.job.AsyncActivatePlanItemInstanceJobHandler;
import mobius.cmmn.engine.impl.job.AsyncInitializePlanModelJobHandler;
import mobius.cmmn.engine.impl.job.TriggerTimerEventJobHandler;
import mobius.cmmn.engine.impl.listener.CmmnListenerFactory;
import mobius.cmmn.engine.impl.listener.CmmnListenerNotificationHelper;
import mobius.cmmn.engine.impl.listener.DefaultCmmnListenerFactory;
import mobius.cmmn.engine.impl.parser.*;
import mobius.cmmn.engine.impl.parser.handler.*;
import mobius.cmmn.engine.impl.persistence.entity.*;
import mobius.cmmn.engine.impl.persistence.entity.data.*;
import mobius.cmmn.engine.impl.persistence.entity.data.impl.*;
import mobius.cmmn.engine.impl.persistence.entity.deploy.CaseDefinitionCacheEntry;
import mobius.cmmn.engine.impl.process.ProcessInstanceService;
import mobius.cmmn.engine.impl.runtime.*;
import mobius.cmmn.engine.impl.scripting.CmmnVariableScopeResolverFactory;
import mobius.cmmn.engine.impl.task.DefaultCmmnTaskVariableScopeResolver;
...
import mobius.cmmn.engine.interceptor.StartCaseInstanceInterceptor;
import mobius.cmmn.image.CaseDiagramGenerator;
import mobius.cmmn.image.impl.DefaultCaseDiagramGenerator;
import mobius.common.engine.api.FlowableException;
import mobius.common.engine.api.delegate.FlowableExpressionEnhancer;
...
import mobius.common.engine.impl.el.function.*;
...
import mobius.entitylink.service.impl.db.EntityLinkDbSchemaManager;
import mobius.eventsubscription.service.EventSubscriptionServiceConfiguration;
import mobius.eventsubscription.service.impl.db.EventSubscriptionDbSchemaManager;
import mobius.form.api.FormFieldHandler;
import mobius.identitylink.service.IdentityLinkEventHandler;
...
import mobius.job.service.*;
import mobius.job.service.impl.asyncexecutor.*;
import mobius.job.service.impl.db.JobDbSchemaManager;
import mobius.job.service.impl.history.async.*;
...
import mobius.task.service.TaskPostProcessor;
import mobius.task.service.TaskServiceConfiguration;
import mobius.task.service.history.InternalHistoryTaskManager;
import mobius.task.service.impl.DefaultTaskPostProcessor;
import mobius.task.service.impl.db.TaskDbSchemaManager;
...
public class CmmnEngineConfiguration extends AbstractEngineConfiguration implements CmmnEngineConfigurationApi,
    ...
    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "mobius/cmmn/db/mapping/mappings.xml";
    ...
    /**
     * Register a global {@link PlanItemInstanceLifecycleListener} to listen to {@link mobius.cmmn.api.runtime.PlanItemInstance} state changes.
     *
     * @param planItemDefinitionType A string from {@link mobius.cmmn.api.runtime.PlanItemDefinitionType}.
     ...
     * {@link mobius.cmmn.api.runtime.PlanItemInstance} state changes.
     */
