 ...
 */
package mobius.cmmn.engine.impl.agenda;

import java.util.Iterator;
import java.util.Map;

import mobius.cmmn.engine.impl.agenda.operation.ActivateAsyncPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.ActivatePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.ChangePlanItemInstanceToAvailableOperation;
import mobius.cmmn.engine.impl.agenda.operation.CmmnOperation;
import mobius.cmmn.engine.impl.agenda.operation.CompleteCaseInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.CompletePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.CreatePlanItemInstanceForRepetitionOperation;
import mobius.cmmn.engine.impl.agenda.operation.CreatePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.DisablePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.DismissPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.EnablePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.EvaluateCriteriaOperation;
import mobius.cmmn.engine.impl.agenda.operation.ExitPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.InitPlanModelInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.InitStageInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.InitiatePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.OccurPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.StartPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.TerminateCaseInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.TerminatePlanItemInstanceOperation;
import mobius.cmmn.engine.impl.agenda.operation.TriggerPlanItemInstanceOperation;
import mobius.cmmn.engine.impl.criteria.PlanItemLifeCycleEvent;
...
import mobius.common.engine.impl.agenda.AbstractAgenda;
