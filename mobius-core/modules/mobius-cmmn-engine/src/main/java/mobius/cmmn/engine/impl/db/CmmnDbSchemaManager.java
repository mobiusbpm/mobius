...
public class CmmnDbSchemaManager extends LiquibaseBasedSchemaManager {
    ...
    public static final String LIQUIBASE_CHANGELOG = "mobius/cmmn/db/liquibase/flowable-cmmn-db-changelog.xml";

    public static final String LIQUIBASE_CHANGELOG_CRDB = "mobius/cmmn/db/liquibase/flowable-cmmn-db-changelog-crdb.xml";
