...
public interface CaseDefinitionEntityManager extends EntityManager<CaseDefinitionEntity> {
    ...
    CaseDefinitionEntity findCaseDefinitionByDeploymentAndKeyAndTenantId(String deploymentId, String caseDefinitionKey,
			String tenantId);

    CaseDefinition findCaseDefinitionByKeyAndVersionAndTenantId(String caseDefinitionKey, Integer caseDefinitionVersion,
			String tenantId);
