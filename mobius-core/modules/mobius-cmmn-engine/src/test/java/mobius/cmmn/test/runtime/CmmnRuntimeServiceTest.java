...
import mobius.cmmn.engine.impl.runtime.CmmnRuntimeServiceImpl;
...
public class CmmnRuntimeServiceTest extends FlowableCmmnTestCase {
    ...
    @Test
    @CmmnDeployment(resources = "mobius/cmmn/test/runtime/oneTaskCase.cmmn")
    ...
    @Test
    @CmmnDeployment(resources = "mobius/cmmn/test/runtime/oneTaskCase.cmmn", tenantId="defaultFlowable")
    ...
    @Test
    @CmmnDeployment(resources = "mobius/cmmn/test/runtime/oneTaskCase.cmmn", tenantId="tenant1")
