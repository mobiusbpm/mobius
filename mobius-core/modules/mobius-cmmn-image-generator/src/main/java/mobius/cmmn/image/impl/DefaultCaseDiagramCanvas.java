...
package mobius.cmmn.image.impl;
...
import mobius.cmmn.image.exception.FlowableImageException;
import mobius.cmmn.image.util.ReflectUtil;
...
public class DefaultCaseDiagramCanvas {
    ...
    public void initialize(String imageType) {
        ...
        try {
            TIMER_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/timer.png", customClassLoader));
            USERLISTENER_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/user.png", customClassLoader));
            USERTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/userTask.png", customClassLoader));
            SERVICETASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/serviceTask.png", customClassLoader));
            CASETASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/caseTask.png", customClassLoader));
            PROCESSTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/processTask.png", customClassLoader));
            DECISIONTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius.icon/decisionTask.png", customClassLoader));
