...
import mobius.cmmn.engine.impl.deployer.ResourceNameUtil;
import mobius.cmmn.rest.api.engine.RestIdentityLink;
import mobius.cmmn.rest.api.engine.variable.QueryVariable;
import mobius.cmmn.rest.api.engine.variable.RestVariable;
import mobius.cmmn.rest.api.engine.variable.RestVariable.RestVariableScope;
import mobius.cmmn.rest.api.history.caze.HistoricCaseInstanceResponse;
import mobius.cmmn.rest.api.history.milestone.HistoricMilestoneInstanceResponse;
import mobius.cmmn.rest.api.history.planitem.HistoricPlanItemInstanceResponse;
import mobius.cmmn.rest.api.history.task.HistoricIdentityLinkResponse;
import mobius.cmmn.rest.api.history.task.HistoricTaskInstanceResponse;
import mobius.cmmn.rest.api.history.variable.HistoricVariableInstanceResponse;
import mobius.cmmn.rest.api.management.JobResponse;
import mobius.cmmn.rest.api.repository.CaseDefinitionResponse;
import mobius.cmmn.rest.api.repository.CmmnDeploymentResponse;
import mobius.cmmn.rest.api.repository.DecisionTableResponse;
import mobius.cmmn.rest.api.repository.DeploymentResourceResponse;
import mobius.cmmn.rest.api.repository.FormDefinitionResponse;
import mobius.cmmn.rest.api.runtime.caze.CaseInstanceResponse;
import mobius.cmmn.rest.api.runtime.planitem.PlanItemInstanceResponse;
import mobius.cmmn.rest.api.runtime.task.TaskResponse;
