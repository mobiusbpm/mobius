 ...
 */
package mobius.cmmn.rest.service;
...
import mobius.cmmn.engine.test.impl.CmmnTestHelper;
import mobius.cmmn.rest.api.RestUrlBuilder;
import mobius.cmmn.rest.conf.ApplicationConfiguration;
import mobius.cmmn.rest.util.TestServerUtil;
import mobius.cmmn.rest.util.TestServerUtil.TestServer;
...
public abstract class BaseSpringRestTestCase extends TestCase {
    ...
    protected static mobius.form.api.FormService formEngineFormService;
    ...
    static {
        ...
        formEngineFormService = appContext.getBean(mobius.form.api.FormService.class);
