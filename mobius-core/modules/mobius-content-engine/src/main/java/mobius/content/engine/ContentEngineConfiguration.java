...
import mobius.content.engine.impl.ContentEngineImpl;
import mobius.content.engine.impl.ContentManagementServiceImpl;
import mobius.content.engine.impl.ContentServiceImpl;
import mobius.content.engine.impl.cfg.StandaloneContentEngineConfiguration;
import mobius.content.engine.impl.cfg.StandaloneInMemContentEngineConfiguration;
import mobius.content.engine.impl.cmd.SchemaOperationsContentEngineBuild;
import mobius.content.engine.impl.db.ContentDbSchemaManager;
import mobius.content.engine.impl.db.EntityDependencyOrder;
import mobius.content.engine.impl.fs.SimpleFileSystemContentStorage;
import mobius.content.engine.impl.persistence.entity.ContentItemEntityManager;
import mobius.content.engine.impl.persistence.entity.ContentItemEntityManagerImpl;
import mobius.content.engine.impl.persistence.entity.TableDataManager;
import mobius.content.engine.impl.persistence.entity.TableDataManagerImpl;
import mobius.content.engine.impl.persistence.entity.data.ContentItemDataManager;
import mobius.content.engine.impl.persistence.entity.data.impl.MybatisContentItemDataManager;

public class ContentEngineConfiguration extends AbstractEngineConfiguration implements ContentEngineConfigurationApi {

    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "mobius/content/db/mapping/mappings.xml";
