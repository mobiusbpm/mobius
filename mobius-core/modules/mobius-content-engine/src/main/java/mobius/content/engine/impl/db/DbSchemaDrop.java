...
package mobius.content.engine.impl.db;
...
public class DbSchemaDrop {
    ...
    public static void main(String[] args) {
        try {
            ...
            Liquibase liquibase = new Liquibase("mobius/content/db/liquibase/flowable-content-db-changelog.xml", new ClassLoaderResourceAccessor(), database);
            liquibase.dropAll();
