...
import mobius.content.engine.impl.TablePageQueryImpl;
import mobius.content.engine.impl.persistence.AbstractManager;
...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
    ...
    protected long getTableCount(String tableName) {
        ...
        Long count = (Long) getDbSqlSession().selectOne("mobius.form.engine.impl.TablePageMap.selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
