 ...
 */
package mobius.content.rest.api.content;
...
import mobius.common.rest.api.RequestUtil;
import mobius.content.api.ContentItem;
import mobius.content.api.ContentService;
import mobius.content.rest.ContentRestResponseFactory;
...
public class ContentItemCollectionResource extends ContentItemBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "body", type = "mobius.rest.rest.service.api.engine.ContentItemRequest", value = "Create a new content item, with content item information", paramType = "body", example = "{\n" + "  \"name\":\"Simple content item\",\n" + "  \"mimeType\":\"application/pdf\",\n"
