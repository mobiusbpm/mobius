...
public class WSDLImporterTest {
    ...
    public void testImportCounter() throws Exception {
        URL url = ReflectUtil.getResource("mobius/engine/impl/webservice/counter.wsdl");
    ...
    public void testImportCounterWithImport() throws Exception {
        URL url = ReflectUtil.getResource("mobius/engine/impl/webservice/counterWithImport.wsdl");
        importer.importFrom(url.toString());
    ...
    public void testImportInheritedElement() throws Exception {
        URL url = ReflectUtil.getResource("mobius/engine/impl/webservice/inherited-elements-in-types.wsdl");
        assertNotNull(url);
        importer.importFrom(url.toString());

        List<StructureDefinition> structures = sortStructures();
        assertEquals(1, structures.size());
        final Object structureTypeInst = ReflectUtil.instantiate("mobius.webservice.counter.StructureType");
    ...
    public void testImportBasicElement() throws Exception {
        URL url = ReflectUtil.getResource("mobius/engine/impl/webservice/basic-elements-in-types.wsdl");
        assertNotNull(url);
        importer.importFrom(url.toString());
    }
    ...
    public void testComplexTypeMixed() throws Exception {
        URL url = ReflectUtil.getResource("mobius/engine/impl/webservice/complexType-mixed.wsdl");
        importer.importFrom(url.toString());
    }
}
