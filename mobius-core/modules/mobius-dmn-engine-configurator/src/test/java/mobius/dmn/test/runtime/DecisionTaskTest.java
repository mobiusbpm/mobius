 ...
 */
package mobius.dmn.test.runtime;
...
public class DecisionTaskTest {
    ...
    @Rule
    public FlowableCmmnRule cmmnRule = new FlowableCmmnRule("mobius/cmmn/test/runtime/DecisionTaskTest.cfg.xml");
    ...
    @Test
    @CmmnDeployment(
            resources = {"mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.cmmn",
                    "mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.dmn"
            }
    )
    ...
    @Test
    @CmmnDeployment(
            resources = { "mobius/cmmn/test/runtime/DecisionTaskTest.testHitFlag.cmmn",
                          "mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.dmn"
            }
    )
    ...
    @Test
    @CmmnDeployment(
            resources = {"mobius/cmmn/test/runtime/DecisionTaskTest.testExpressionReferenceKey.cmmn",
                    "mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.dmn"
            }
    )
    ...
    @CmmnDeployment(
            resources = {
                    "mobius/cmmn/test/runtime/DecisionTaskTest.testBlocking.cmmn",
                    "mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.dmn"
            }
    )
    ...
    @Test
    @CmmnDeployment(
        resources = {"mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTaskFallBackToDefaultTenant.cmmn"},
        tenantId = "flowable"
    )
    ...
    @Test
    @CmmnDeployment(
        resources = {"mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTaskFallBackToDefaultTenantFalse.cmmn"},
        tenantId = "flowable"
    )
    ...
    protected void deployDmnTableAssertCaseStarted() {
        mobius.cmmn.api.repository.CmmnDeployment cmmnDeployment = cmmnRule.getCmmnRepositoryService().createDeployment().
            addClasspathResource("mobius/cmmn/test/runtime/DecisionTaskTest.testDecisionServiceTask.dmn").
