...
import mobius.dmn.engine.impl.DmnEngineImpl;
import mobius.dmn.engine.impl.DmnHistoryServiceImpl;
import mobius.dmn.engine.impl.DmnManagementServiceImpl;
import mobius.dmn.engine.impl.DmnRepositoryServiceImpl;
import mobius.dmn.engine.impl.DmnRuleServiceImpl;
import mobius.dmn.engine.impl.RuleEngineExecutorImpl;
import mobius.dmn.engine.impl.cfg.StandaloneDmnEngineConfiguration;
import mobius.dmn.engine.impl.cfg.StandaloneInMemDmnEngineConfiguration;
import mobius.dmn.engine.impl.cmd.SchemaOperationsDmnEngineBuild;
import mobius.dmn.engine.impl.db.DmnDbSchemaManager;
import mobius.dmn.engine.impl.db.EntityDependencyOrder;
import mobius.dmn.engine.impl.deployer.CachingAndArtifactsManager;
import mobius.dmn.engine.impl.deployer.DmnDeployer;
import mobius.dmn.engine.impl.deployer.DmnDeploymentHelper;
import mobius.dmn.engine.impl.deployer.ParsedDeploymentBuilderFactory;
import mobius.dmn.engine.impl.el.FlowableAddDateFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableAllOfFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableAnyOfFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableContainsAnyFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableContainsFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableCurrentDateFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableNoneOfFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableNotAllOfFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableNotContainsAnyFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableNotContainsFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableSubtractDateFunctionDelegate;
import mobius.dmn.engine.impl.el.FlowableToDateFunctionDelegate;
import mobius.dmn.engine.impl.hitpolicy.AbstractHitPolicy;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyAny;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyCollect;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyFirst;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyOutputOrder;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyPriority;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyRuleOrder;
import mobius.dmn.engine.impl.hitpolicy.HitPolicyUnique;
import mobius.dmn.engine.impl.parser.DmnParseFactory;
import mobius.dmn.engine.impl.persistence.deploy.DecisionTableCacheEntry;
import mobius.dmn.engine.impl.persistence.deploy.Deployer;
import mobius.dmn.engine.impl.persistence.deploy.DeploymentManager;
import mobius.dmn.engine.impl.persistence.entity.DecisionTableEntityManager;
import mobius.dmn.engine.impl.persistence.entity.DecisionTableEntityManagerImpl;
import mobius.dmn.engine.impl.persistence.entity.DmnDeploymentEntityManager;
import mobius.dmn.engine.impl.persistence.entity.DmnDeploymentEntityManagerImpl;
import mobius.dmn.engine.impl.persistence.entity.DmnResourceEntityManager;
import mobius.dmn.engine.impl.persistence.entity.DmnResourceEntityManagerImpl;
import mobius.dmn.engine.impl.persistence.entity.HistoricDecisionExecutionEntityManager;
import mobius.dmn.engine.impl.persistence.entity.HistoricDecisionExecutionEntityManagerImpl;
import mobius.dmn.engine.impl.persistence.entity.TableDataManager;
import mobius.dmn.engine.impl.persistence.entity.TableDataManagerImpl;
...
import mobius.dmn.engine.impl.persistence.entity.data.impl.MybatisDecisionTableDataManager;
import mobius.dmn.engine.impl.persistence.entity.data.impl.MybatisDmnDeploymentDataManager;
import mobius.dmn.engine.impl.persistence.entity.data.impl.MybatisDmnResourceDataManager;
import mobius.dmn.engine.impl.persistence.entity.data.impl.MybatisHistoricDecisionExecutionDataManager;
...
public class DmnEngineConfiguration extends AbstractEngineConfiguration
    ...
    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "mobius/dmn/db/mapping/mappings.xml";
