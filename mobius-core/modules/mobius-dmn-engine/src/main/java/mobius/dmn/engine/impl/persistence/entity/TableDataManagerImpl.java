...
import mobius.dmn.engine.impl.TablePageQueryImpl;
import mobius.dmn.engine.impl.persistence.AbstractManager;
...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
    ...
    protected long getTableCount(String tableName) {
        ...
        Long count = (Long) getDbSqlSession().selectOne("mobius.dmn.engine.impl.TablePageMap.selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
