 ...
 */
package mobius.dmn.engine.test.deployment;
...
public class DeploymentTest extends AbstractFlowableDmnTest {
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/multiple_conclusions_DMN12.dmn")
    ...
    public void deploySingleDecisionAndValidateVersioning() {
        ...
        repositoryService.createDeployment().name("secondDeployment")
                .addClasspathResource("mobius/dmn/engine/test/deployment/multiple_conclusions.dmn")
                .deploy();
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/multiple_decisions.dmn")
    ...
    public void deployWithCategory() throws Exception {
        ...
        mobius.dmn.api.DmnDeployment deployment = repositoryService.createDeploymentQuery().deploymentCategory("TEST_DEPLOYMENT_CATEGORY").singleResult();
    ...
    public void deploySingleDecisionWithParentDeploymentId() {
        mobius.dmn.api.DmnDeployment deployment = repositoryService.createDeployment()
                .addClasspathResource("mobius/dmn/engine/test/deployment/multiple_conclusions.dmn")
                .parentDeploymentId("someDeploymentId")
                .deploy();
        
        mobius.dmn.api.DmnDeployment newDeployment = repositoryService.createDeployment()
                .addClasspathResource("mobius/dmn/engine/test/deployment/multiple_conclusions.dmn")
                .deploy();
    ...
    protected void deleteDeployments() {
        List<mobius.dmn.api.DmnDeployment> deployments = repositoryService.createDeploymentQuery().list();
        for (mobius.dmn.api.DmnDeployment deployment : deployments) {
            repositoryService.deleteDeployment(deployment.getId());
        }
    }
}
