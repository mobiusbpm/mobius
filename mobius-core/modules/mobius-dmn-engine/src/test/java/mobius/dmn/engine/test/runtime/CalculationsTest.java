...
public class CalculationsTest {
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/runtime/calculations2.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/runtime/calculations.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/runtime/calculations_variable_update_1.dmn")
