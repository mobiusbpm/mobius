...
public class RuntimeTest extends AbstractFlowableDmnTest {
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/multiple_conclusions.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/dates_1.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/dates_2.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/dates_3.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/dates_5.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/strings_1.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/strings_2.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/outcome_expression_1.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/outcome_expression_2.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/outcome_expression_3.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/outcome_expression_4.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/outcome_expression_5.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/empty_expressions.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/dates_4.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/reservered_word.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/empty_tokens.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/risk_rating_spec_example.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/risk_rating_spec_example_DMN12.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/numbers_1.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/simple.dmn")
    ...
    @Test
    @DmnDeployment(resources = "mobius/dmn/engine/test/deployment/json.dmn")
