 ...
 */
package mobius.dmn.rest.service.api.decision;
...
public class DmnRuleServiceResourceTest extends BaseSpringDmnRestTestCase {
    ...
    @DmnDeployment(resources = { "mobius/dmn/rest/service/api/decision/multi-hit.dmn" })
    ...
    @DmnDeployment(resources = { "mobius/dmn/rest/service/api/decision/single-hit.dmn" })
