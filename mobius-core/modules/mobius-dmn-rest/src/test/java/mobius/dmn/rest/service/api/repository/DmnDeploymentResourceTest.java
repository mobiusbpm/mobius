...
public class DmnDeploymentResourceTest extends BaseSpringDmnRestTestCase {
     ...
     */
    @DmnDeploymentAnnotation(resources = { "mobius/dmn/rest/service/api/repository/simple.dmn" })
    public void testGetDeployment() throws Exception {
        mobius.dmn.api.DmnDeployment existingDeployment = dmnRepositoryService.createDeploymentQuery().singleResult();
     ...
     */
    @DmnDeployment(resources = { "mobius/dmn/rest/service/api/repository/simple.dmn" })
