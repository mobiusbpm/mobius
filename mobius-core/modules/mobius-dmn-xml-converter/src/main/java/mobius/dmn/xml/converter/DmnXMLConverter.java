...
import mobius.dmn.converter.util.DmnXMLUtil;
import mobius.dmn.model.BuiltinAggregator;
...
import mobius.dmn.model.ItemDefinition;
...
import mobius.dmn.xml.exception.DmnXMLException;
...
public class DmnXMLConverter implements DmnXMLConstants {
    ...
    protected static final String DMN_XSD = "mobius/impl/dmn/parser/DMN12.xsd";
    protected static final String DMN_11_XSD = "mobius/impl/dmn/parser/dmn.xsd";
