 ...
 */
package mobius.common.engine.impl;
...
import mobius.common.engine.impl.cfg.standalone.StandaloneMybatisTransactionContextFactory;
import mobius.common.engine.impl.db.*;
import mobius.common.engine.impl.event.EventDispatchAction;
...
public abstract class AbstractEngineConfiguration {
    ...
    public String pathToEngineDbProperties() {
        return "mobius/common/db/properties/" + databaseType + ".properties";
    }
