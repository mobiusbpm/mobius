...
import mobius.common.engine.impl.FlowableVersion;
...
public abstract class AbstractSqlScriptBasedDbSchemaManager implements SchemaManager {
    ...
    public String getResourceForMobiusDbOperation(String directory, String operation, String component,
            String databaseType) {
        return getResourcesRootDirectory() + directory + "/mobius." + databaseType + "."
   ...
   /*     String databaseType = getDbSqlSession().getDbSqlSessionFactory().getDatabaseType();
        ...
        executeSchemaResource(operation, component, getResourceForMobiusDbOperation(operation, operation, component,
                databaseType), false);*/
