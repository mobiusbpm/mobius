...
import mobius.common.engine.impl.de.odysseus.el.misc.BooleanOperations;
import mobius.common.engine.impl.de.odysseus.el.misc.NumberOperations;
...
public class AstBinary extends AstRightValue {
	...
	public static final Operator ADD = new SimpleOperator() {
		@Override public Object apply(TypeConverter converter, Object o1, Object o2) { return NumberOperations
				.add(converter, o1, o2); }
	...
	public static final Operator EQ = new SimpleOperator() {
		@Override public Object apply(TypeConverter converter, Object o1, Object o2) { return BooleanOperations
				.eq(converter, o1, o2); }
		@Override public String toString() { return "=="; }
	};
