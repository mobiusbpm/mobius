...
public interface IdentityService {
    ...
    /**
     * Saves the user. If the user already existed, the user is updated except user password. Use {@link
     * #updateUserPassword(User)} to update existing user password.
     *
    ...
    /**
     * Returns a new {@link mobius.common.engine.api.query.NativeQuery} for tasks.
     */
    NativeUserQuery createNativeUserQuery();

    /**
     * @param userId id of user to delete, cannot be null. When an id is passed for a non-existent user, this operation
     *               is ignored.
     */
     ...
     * @throws FlowableObjectNotFoundException if the user doesn't exist.
     */
