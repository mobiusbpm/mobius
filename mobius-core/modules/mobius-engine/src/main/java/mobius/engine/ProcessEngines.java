 ...
 * context-listener ( <code>mobius.impl.servlet.listener.ProcessEnginesServletContextListener</code> ). That way, all applications can just use the {@link #getProcessEngines()} to obtain
...
public abstract class ProcessEngines {
    ...
    protected static void initProcessEngineFromSpringResource(URL resource) {
        try {
            Class<?> springConfigurationHelperClass = ReflectUtil.loadClass("mobius.spring.SpringConfigurationHelper");
