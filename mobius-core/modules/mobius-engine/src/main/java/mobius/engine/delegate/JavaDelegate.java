...
package mobius.engine.delegate;
 ...
 * condition defined) If you are in need of influencing the flow in your process, use the class 'mobius.engine.impl.pvm.delegate.ActivityBehavior' instead.
 * 
 *
 */
