...
import mobius.engine.dynamic.DynamicProcessDefinitionSummary;
import mobius.engine.impl.cfg.ProcessEngineConfigurationImpl;
import mobius.engine.impl.cmd.GetBpmnModelCmd;
import mobius.engine.impl.cmd.GetProcessDefinitionInfoCmd;
import mobius.engine.impl.cmd.InjectEmbeddedSubProcessInProcessInstanceCmd;
import mobius.engine.impl.cmd.InjectParallelEmbeddedSubProcessCmd;
import mobius.engine.impl.cmd.InjectParallelUserTaskCmd;
import mobius.engine.impl.cmd.InjectUserTaskInProcessInstanceCmd;
import mobius.engine.impl.cmd.SaveProcessDefinitionInfoCmd;
import mobius.engine.impl.dynamic.DynamicEmbeddedSubProcessBuilder;
import mobius.engine.impl.dynamic.DynamicUserTaskBuilder;
