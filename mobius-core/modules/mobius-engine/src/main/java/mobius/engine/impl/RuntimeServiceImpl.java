...
import mobius.engine.impl.cmd.ActivateProcessInstanceCmd;
import mobius.engine.impl.cmd.AddEventListenerCommand;
import mobius.engine.impl.cmd.AddIdentityLinkForProcessInstanceCmd;
import mobius.engine.impl.cmd.AddMultiInstanceExecutionCmd;
import mobius.engine.impl.cmd.ChangeActivityStateCmd;
import mobius.engine.impl.cmd.CompleteAdhocSubProcessCmd;
import mobius.engine.impl.cmd.DeleteIdentityLinkForProcessInstanceCmd;
import mobius.engine.impl.cmd.DeleteMultiInstanceExecutionCmd;
import mobius.engine.impl.cmd.DeleteProcessInstanceCmd;
import mobius.engine.impl.cmd.DispatchEventCommand;
import mobius.engine.impl.cmd.EvaluateConditionalEventsCmd;
import mobius.engine.impl.cmd.ExecuteActivityForAdhocSubProcessCmd;
import mobius.engine.impl.cmd.FindActiveActivityIdsCmd;
import mobius.engine.impl.cmd.GetActiveAdhocSubProcessesCmd;
import mobius.engine.impl.cmd.GetDataObjectCmd;
import mobius.engine.impl.cmd.GetDataObjectsCmd;
import mobius.engine.impl.cmd.GetEnabledActivitiesForAdhocSubProcessCmd;
import mobius.engine.impl.cmd.GetEntityLinkChildrenForProcessInstanceCmd;
import mobius.engine.impl.cmd.GetEntityLinkChildrenForTaskCmd;
import mobius.engine.impl.cmd.GetEntityLinkParentsForProcessInstanceCmd;
import mobius.engine.impl.cmd.GetEntityLinkParentsForTaskCmd;
import mobius.engine.impl.cmd.GetExecutionVariableCmd;
import mobius.engine.impl.cmd.GetExecutionVariableInstanceCmd;
import mobius.engine.impl.cmd.GetExecutionVariableInstancesCmd;
import mobius.engine.impl.cmd.GetExecutionVariablesCmd;
import mobius.engine.impl.cmd.GetExecutionsVariablesCmd;
import mobius.engine.impl.cmd.GetIdentityLinksForProcessInstanceCmd;
import mobius.engine.impl.cmd.GetProcessInstanceEventsCmd;
import mobius.engine.impl.cmd.GetStartFormCmd;
import mobius.engine.impl.cmd.GetStartFormModelCmd;
import mobius.engine.impl.cmd.HasExecutionVariableCmd;
import mobius.engine.impl.cmd.MessageEventReceivedCmd;
import mobius.engine.impl.cmd.ProcessInstanceMigrationCmd;
import mobius.engine.impl.cmd.ProcessInstanceMigrationValidationCmd;
import mobius.engine.impl.cmd.RemoveEventListenerCommand;
import mobius.engine.impl.cmd.RemoveExecutionVariablesCmd;
import mobius.engine.impl.cmd.SetExecutionVariablesCmd;
import mobius.engine.impl.cmd.SetProcessInstanceBusinessKeyCmd;
import mobius.engine.impl.cmd.SetProcessInstanceNameCmd;
import mobius.engine.impl.cmd.SignalEventReceivedCmd;
import mobius.engine.impl.cmd.StartProcessInstanceAsyncCmd;
import mobius.engine.impl.cmd.StartProcessInstanceByMessageCmd;
import mobius.engine.impl.cmd.StartProcessInstanceCmd;
import mobius.engine.impl.cmd.SuspendProcessInstanceCmd;
import mobius.engine.impl.cmd.TriggerCmd;
import mobius.engine.impl.migration.ProcessInstanceMigrationBuilderImpl;
...
import mobius.engine.runtime.NativeExecutionQuery;
