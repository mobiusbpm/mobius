...
import mobius.bpmn.model.DataAssociation;
import mobius.bpmn.model.DataSpec;
import mobius.bpmn.model.FlowElement;
import mobius.bpmn.model.IOSpecification;
import mobius.bpmn.model.Import;
import mobius.bpmn.model.Interface;
...
import mobius.engine.impl.bpmn.data.AbstractDataAssociation;
import mobius.engine.impl.bpmn.data.Assignment;
import mobius.engine.impl.bpmn.data.ClassStructureDefinition;
import mobius.engine.impl.bpmn.data.ItemDefinition;
import mobius.engine.impl.bpmn.data.ItemInstance;
import mobius.engine.impl.bpmn.data.ItemKind;
import mobius.engine.impl.bpmn.data.SimpleDataInputAssociation;
import mobius.engine.impl.bpmn.data.StructureDefinition;
import mobius.engine.impl.bpmn.data.TransformationDataOutputAssociation;
import mobius.engine.impl.bpmn.helper.ErrorPropagation;
import mobius.engine.impl.bpmn.parser.XMLImporter;
import mobius.engine.impl.bpmn.webservice.BpmnInterface;
import mobius.engine.impl.bpmn.webservice.MessageDefinition;
import mobius.engine.impl.bpmn.webservice.MessageImplicitDataInputAssociation;
import mobius.engine.impl.bpmn.webservice.MessageImplicitDataOutputAssociation;
...
import mobius.engine.impl.webservice.WSOperation;
import mobius.engine.impl.webservice.WSService;
...
public class WebServiceActivityBehavior extends AbstractBpmnActivityBehavior {
    ...
    public static final String CURRENT_MESSAGE = "mobius.engine.impl.bpmn.CURRENT_MESSAGE";
    ...
    protected void createItemDefinitions(BpmnModel bpmnModel) {
        ...
        for (mobius.bpmn.model.ItemDefinition itemDefinitionElement : bpmnModel.getItemDefinitions().values()) {
    ...
    protected void createOperations(BpmnModel bpmnModel) {
        for (Interface interfaceObject : bpmnModel.getInterfaces()) {
            ...
            for (mobius.bpmn.model.Operation operationObject : interfaceObject.getOperations()) {
    ...
    protected AbstractDataAssociation createDataInputAssociation(DataAssociation dataAssociationElement) {
        if (dataAssociationElement.getAssignments().isEmpty()) {
            ...
            for (mobius.bpmn.model.Assignment assignmentElement : dataAssociationElement.getAssignments()) {
