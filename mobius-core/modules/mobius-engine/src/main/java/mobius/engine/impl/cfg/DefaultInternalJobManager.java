...
import mobius.common.engine.impl.calendar.CycleBusinessCalendar;
...
public class DefaultInternalJobManager implements InternalJobManager {
    ...
    public void preTimerJobDelete(JobEntity jobEntity, VariableScope variableScope) {
        ...
        if (jobEntity.getProcessDefinitionId() != null) {
            mobius.bpmn.model.Process process = ProcessDefinitionUtil.getProcess(jobEntity.getProcessDefinitionId());
    ...
    protected int getMaxIterations(mobius.bpmn.model.Process process, String activityId) {
