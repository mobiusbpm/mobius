...
import mobius.engine.delegate.DelegateHelper;
...
public enum DelegateExpressionFieldInjectionMode {
     ...
     * 
     * Using the {@link DelegateHelper#getField(mobius.engine.delegate.DelegateExecution, String)} method is not possible when using this mode, unless the Expressions are still defined as
