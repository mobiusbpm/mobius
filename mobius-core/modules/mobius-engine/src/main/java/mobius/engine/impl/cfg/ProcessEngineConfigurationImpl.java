...
import mobius.common.engine.impl.event.FlowableEventDispatcherImpl;
import mobius.common.engine.impl.history.HistoryLevel;
import mobius.common.engine.impl.interceptor.*;
import mobius.common.engine.impl.persistence.GenericManagerFactory;
import mobius.common.engine.impl.persistence.cache.EntityCache;
import mobius.common.engine.impl.persistence.cache.EntityCacheImpl;
...
import mobius.engine.app.AppResourceConverter;
import mobius.engine.compatibility.DefaultFlowable5CompatibilityHandlerFactory;
import mobius.engine.compatibility.Flowable5CompatibilityHandler;
import mobius.engine.compatibility.Flowable5CompatibilityHandlerFactory;
import mobius.engine.delegate.event.impl.BpmnModelEventDispatchAction;
import mobius.engine.dynamic.DynamicStateManager;
import mobius.engine.form.AbstractFormType;
import mobius.engine.impl.*;
import mobius.engine.impl.agenda.AgendaSessionFactory;
import mobius.engine.impl.agenda.DefaultFlowableEngineAgendaFactory;
import mobius.engine.impl.app.AppDeployer;
import mobius.engine.impl.app.AppResourceConverterImpl;
import mobius.engine.impl.bpmn.deployer.*;
import mobius.engine.impl.bpmn.listener.ListenerNotificationHelper;
import mobius.engine.impl.bpmn.parser.BpmnParseHandlers;
import mobius.engine.impl.bpmn.parser.BpmnParser;
import mobius.engine.impl.bpmn.parser.factory.*;
import mobius.engine.impl.bpmn.parser.handler.*;
import mobius.engine.impl.cmd.RedeployV5ProcessDefinitionsCmd;
...
import mobius.engine.impl.cmd.ValidateV5EntitiesCmd;
...
import mobius.engine.impl.db.ProcessDbSchemaManager;
import mobius.engine.impl.delegate.invocation.DefaultDelegateInterceptor;
import mobius.engine.impl.dynamic.DefaultDynamicStateManager;
import mobius.engine.impl.el.FlowableDateFunctionDelegate;
import mobius.engine.impl.el.ProcessExpressionManager;
import mobius.engine.impl.event.CompensationEventHandler;
import mobius.engine.impl.event.EventHandler;
import mobius.engine.impl.event.MessageEventHandler;
import mobius.engine.impl.event.SignalEventHandler;
import mobius.engine.impl.event.logger.EventLogger;
import mobius.engine.impl.form.*;
import mobius.engine.impl.formhandler.DefaultFormFieldHandler;
import mobius.engine.impl.history.DefaultHistoryManager;
import mobius.engine.impl.history.DefaultHistoryTaskManager;
import mobius.engine.impl.history.DefaultHistoryVariableManager;
import mobius.engine.impl.history.HistoryManager;
import mobius.engine.impl.history.async.AsyncHistoryManager;
import mobius.engine.impl.history.async.HistoryJsonConstants;
import mobius.engine.impl.history.async.json.transformer.*;
import mobius.engine.impl.interceptor.*;
import mobius.engine.impl.jobexecutor.*;
import mobius.engine.impl.migration.ProcessInstanceMigrationManagerImpl;
...
import mobius.engine.impl.persistence.deploy.ProcessDefinitionInfoCache;
import mobius.engine.impl.persistence.entity.*;
import mobius.engine.impl.persistence.entity.data.*;
import mobius.engine.impl.persistence.entity.data.impl.*;
import mobius.engine.impl.scripting.VariableScopeResolverFactory;
import mobius.engine.impl.util.ProcessInstanceHelper;
import mobius.engine.interceptor.*;
import mobius.engine.migration.ProcessInstanceMigrationManager;
...
import mobius.task.api.TaskQueryInterceptor;
import mobius.task.api.history.HistoricTaskQueryInterceptor;
import mobius.task.service.InternalTaskAssignmentManager;
import mobius.task.service.InternalTaskLocalizationManager;
...
import mobius.validation.ProcessValidatorFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration implements
    ...
    public static final String DEFAULT_WS_SYNC_FACTORY = "mobius.engine.impl.webservice.CxfWebServiceClientFactory";

    public static final String DEFAULT_WS_IMPORTER = "mobius.engine.impl.webservice.CxfWSDLImporter";
