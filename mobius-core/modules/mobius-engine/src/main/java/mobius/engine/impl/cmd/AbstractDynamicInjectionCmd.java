...
import mobius.common.engine.impl.util.io.BytesStreamSource;
import mobius.engine.impl.dynamic.BaseDynamicSubProcessInjectUtil;
...
public abstract class AbstractDynamicInjectionCmd {
    ...
    protected BpmnModel createBpmnModel(CommandContext commandContext, ProcessDefinitionEntity originalProcessDefinitionEntity, DeploymentEntity newDeploymentEntity) {
        ...
        mobius.bpmn.model.Process process = bpmnModel.getProcessById(originalProcessDefinitionEntity.getKey());
        updateBpmnProcess(commandContext, process, bpmnModel, originalProcessDefinitionEntity, newDeploymentEntity);
        return bpmnModel;
    }

    protected abstract void updateBpmnProcess(CommandContext commandContext, mobius.bpmn.model.Process process,
