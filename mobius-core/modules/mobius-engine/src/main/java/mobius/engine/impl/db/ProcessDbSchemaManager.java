...
import mobius.common.engine.impl.db.AbstractSqlScriptBasedDbSchemaManager;
...
public class ProcessDbSchemaManager extends AbstractSqlScriptBasedDbSchemaManager {
    ...
    protected String getDbVersion() {
        ...
        String selectSchemaVersionStatement = dbSqlSession.getDbSqlSessionFactory().mapStatement("mobius.engine.impl.persistence.entity.PropertyEntityImpl.selectDbSchemaVersion");
...
/*            if (version6120Index > matchingVersionIndex) {
        ...
        if (isHistoryTablePresent && isUpgradeNeeded) {
//            if (isUpgradeNeeded) {
...
//            }
    ...
    public void performSchemaOperationsProcessEngineClose() {
        ...
        if (mobius.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_CREATE_DROP.equals(databaseSchemaUpdate)) {
            schemaDrop();
        }
    }
