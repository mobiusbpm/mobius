...
public class DefaultFormHandler implements FormHandler {
    ...
    @Override
    public void parseConfiguration(List<mobius.bpmn.model.FormProperty> formProperties, String formKey, DeploymentEntity deployment, ProcessDefinition processDefinition) {
        ...
        for (mobius.bpmn.model.FormProperty formProperty : formProperties) {
