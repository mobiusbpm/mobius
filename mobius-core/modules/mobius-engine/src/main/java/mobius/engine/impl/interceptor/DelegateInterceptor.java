...
import mobius.engine.impl.delegate.invocation.DelegateInvocation;
 ...
 * <ul>
 * <li>{@link mobius.engine.delegate.JavaDelegate}</li>
 * <li>{@link mobius.engine.delegate.ExecutionListener}</li>
 * <li>{@link mobius.engine.delegate.Expression}</li>
 * <li>{@link mobius.engine.delegate.TaskListener}</li>
 * </ul>
 * 
