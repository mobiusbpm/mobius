...
import mobius.common.engine.api.management.TablePage;
...
import mobius.engine.impl.TablePageQueryImpl;
import mobius.engine.impl.cfg.ProcessEngineConfigurationImpl;
import mobius.engine.impl.persistence.AbstractManager;
...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
    ...
    protected long getTableCount(String tableName) {
        ...
        Long count = (Long) getDbSqlSession().selectOne("mobius.engine.impl.TablePageMap.selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
    ...
    public TablePage getTablePage(TablePageQueryImpl tablePageQuery, int firstResult, int maxResults) {
        ...
        List tableData = getDbSqlSession().getSqlSession().selectList("mobius.engine.impl.TablePageMap.selectTableData", tablePageQuery, new RowBounds(firstResult, maxResults));
