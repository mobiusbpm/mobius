 ...
 */
package mobius.engine.repository;
 ...
 * 
 * When a deployment is 'deployed' through the {@link mobius.engine.RuntimeService}, the process engine will recognize certain of such resource types and act upon them (eg process definitions
