...
import mobius.engine.delegate.event.FlowableErrorEvent;
import mobius.engine.delegate.event.FlowableMessageEvent;
import mobius.engine.delegate.event.FlowableSignalEvent;
import mobius.engine.delegate.event.impl.FlowableActivityEventImpl;
import mobius.engine.delegate.event.impl.FlowableSignalEventImpl;
...
public class ActivityEventsTest extends PluggableFlowableTestCase {
     ...
     */
    @Test
    @Deployment(resources = "mobius/engine/test/api/event/ActivityEventsTest.testActivityMessageEventsInEventSubprocess.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/event/JobEventsTest.testJobEntityEvents.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/event/timer/BoundaryTimerEventTest.testTimerOnNestingOfSubprocesses.bpmn20.xml")
     ...
     */
    @Test
    @Deployment(resources = "mobius/engine/test/api/event/ActivityEventsTest.testActivityMessageBoundaryEventsOnUserTask.bpmn20.xml")
     ...
     */
    @Test
    @Deployment(resources = "mobius/engine/test/api/event/ActivityEventsTest.testActivityMessageBoundaryEventsOnSubProcess.bpmn20.xml")
