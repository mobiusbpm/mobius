...
import mobius.engine.impl.jobexecutor.AsyncCompleteCallActivityJobHandler;
...
public class CallActivityTest extends PluggableFlowableTestCase {
    ...
    @Deployment(resources = {
            "mobius/engine/test/api/event/CallActivityTest.testCallActivity.bpmn20.xml",
            "mobius/engine/test/api/event/CallActivityTest.testCalledActivity.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/api/event/CallActivityTest.testCallActivityTerminateEnd.bpmn20.xml",
            "mobius/engine/test/api/event/CallActivityTest.testCalledActivityTerminateEnd.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/api/event/CallActivityTest.testCallActivityProcessInstanceName.bpmn20.xml",
            "mobius/engine/test/api/event/CallActivityTest.testCalledActivity.bpmn20.xml"
    })
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/api/event/CallActivityTest.testCallActivityAsyncComplete.bpmn20.xml",
            "mobius/engine/test/api/event/CallActivityTest.testCallActivityAsyncComplete_subprocess.bpmn20.xml"
    })
