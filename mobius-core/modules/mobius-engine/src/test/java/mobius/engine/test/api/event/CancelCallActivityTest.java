...
public class CancelCallActivityTest extends PluggableFlowableTestCase {
    ...
    @Deployment(resources = {
            "mobius/engine/test/api/event/CancelCallActivityTest.testActivityMessageBoundaryEventsOnCallActivity.bpmn20.xml",
            "mobius/engine/test/api/event/CancelCallActivityTest.testActivityMessageBoundaryEventsCalledActivity.bpmn20.xml" })
