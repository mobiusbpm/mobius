...
import mobius.engine.delegate.event.FlowableMultiInstanceActivityCancelledEvent;
import mobius.engine.delegate.event.FlowableMultiInstanceActivityCompletedEvent;
import mobius.engine.delegate.event.FlowableMultiInstanceActivityEvent;
...
public class MultiInstanceUserTaskEventsTest extends PluggableFlowableTestCase {
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.bpmn20.xml"})
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.testMultiInstanceCompleteCondition.bpmn20.xml"})
    ...
    @Deployment(resources = {
            "mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.testCallActivityTerminateEnd.bpmn20.xml",
            "mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.testCalledActivityTerminateEnd.bpmn20.xml"})
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.testEmbeddedSubprocess.bpmn20.xml"})
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/api/event/MultiInstanceUserTaskEventsTest.testMultiInstanceSequentialUserTaskEventsWithNormalCompletion.bpmn20.xml"})
