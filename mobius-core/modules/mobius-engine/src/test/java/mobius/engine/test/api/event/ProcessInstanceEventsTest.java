...
import mobius.engine.delegate.event.FlowableActivityCancelledEvent;
import mobius.engine.delegate.event.FlowableCancelledEvent;
import mobius.engine.delegate.event.FlowableProcessStartedEvent;
import mobius.engine.delegate.event.impl.FlowableActivityCancelledEventImpl;
...
public class ProcessInstanceEventsTest extends PluggableFlowableTestCase {
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "mobius/engine/test/api/runtime/subProcess.bpmn20.xml"})
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/event/signal/SignalEventTest.testSignalWithGlobalScope.bpmn20.xml"})
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/ProcessInstanceEventsTest.noneTaskProcess.bpmn20.xml"})
    ...
    /**
     * Test Start->User mobius.task.service.Task process on PROCESS_COMPLETED event
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/ProcessInstanceEventsTest.noEndProcess.bpmn20.xml"})
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/ProcessInstanceEventsTest.parallelGatewayNoEndProcess.bpmn20.xml"})
     ...
     */
    @Test
    @Deployment(resources = {"mobius/engine/test/api/event/ProcessInstanceEventsTest.parallelGatewayTwoEndsProcess.bpmn20.xml"})
    ...
    @Deployment(resources = {
            "mobius/engine/test/bpmn/event/end/TerminateEndEventTest.testTerminateInCallActivityMulitInstance.bpmn",
            "mobius/engine/test/bpmn/event/end/TerminateEndEventTest.subProcessTerminateTerminateAll.bpmn20.xml"})
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/event/end/TerminateEndEventTest.testProcessTerminate.bpmn")
    ...
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/event/end/TerminateEndEventTest.testTerminateInCallActivity.bpmn",
            "mobius/engine/test/bpmn/event/end/TerminateEndEventTest.subProcessTerminate.bpmn"})
    ...
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/event/end/TerminateEndEventTest.testTerminateInSubProcessWithBoundaryTerminateAll.bpmn20.xml"})
    ...
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/event/end/TerminateEndEventTest.testTerminateInParentProcess.bpmn",
            "mobius/engine/test/api/runtime/oneTaskProcess.bpmn20.xml"})
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/bpmn/event/error/BoundaryErrorEventTest.testCatchErrorOnCallActivity-parent.bpmn20.xml",
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/bpmn/multiinstance/MultiInstanceTest.testParallelCallActivity.bpmn20.xml",
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/runtime/subProcessWithTerminateEnd.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/runtime/multipleSubprocessTerminateEnd.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/event/ProcessInstanceEventsTest.testProcessInstanceEvents.bpmn20.xml")
