...
public class SignalThrowingEventListenerTest extends PluggableFlowableTestCase {
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/api/event/SignalThrowingEventListenerTest.testThrowSignalInNewTransaction.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/api/event/SignalThrowingEventListenerTest.globalSignal.bpmn20.xml",
            "mobius/engine/test/api/event/SignalThrowingEventListenerTest.globalSignalExternalProcess.bpmn20.xml" })
    public void testGlobalSignal() throws Exception {
        ...
        try {
            ...
            // mobius.task.service.Task assignee should still be set
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/api/event/SignalThrowingEventListenerTest.globalSignalDefinedInProcessDefinition.bpmn20.xml",
            "mobius/engine/test/api/event/SignalThrowingEventListenerTest.globalSignalExternalProcess.bpmn20.xml" })
