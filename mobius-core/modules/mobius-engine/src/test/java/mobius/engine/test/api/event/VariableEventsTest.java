...
public class VariableEventsTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/processVariableEvent.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/callActivity.bpmn20.xml", "mobius/engine/test/api/runtime/calledActivity.bpmn20.xml" })
