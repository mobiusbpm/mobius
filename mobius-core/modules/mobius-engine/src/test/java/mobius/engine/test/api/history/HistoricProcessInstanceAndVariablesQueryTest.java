...
public class HistoricProcessInstanceAndVariablesQueryTest extends PluggableFlowableTestCase {
    ...
    protected void setUp() throws Exception {
        repositoryService.createDeployment()
                ...
                .addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess2.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess3.bpmn20.xml")
                .deploy();
