...
import mobius.engine.test.api.runtime.ProcessInstanceQueryTest;
...
public class HistoryServiceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/oneTaskProcess.bpmn20.xml", "mobius/examples/bpmn/callactivity/orderProcess.bpmn20.xml",
            "mobius/examples/bpmn/callactivity/checkCreditProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/oneTaskProcess.bpmn20.xml", "mobius/engine/test/api/runtime/oneTaskProcess2.bpmn20.xml" })
