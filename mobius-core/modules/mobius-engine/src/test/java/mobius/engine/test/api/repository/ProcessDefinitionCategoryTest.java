...
public class ProcessDefinitionCategoryTest extends PluggableFlowableTestCase {
    ...
    public void testQueryByCategoryNotEquals() {
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/repository/processCategoryOne.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/repository/processCategoryTwo.bpmn20.xml").addClasspathResource("mobius/engine/test/api/repository/processCategoryThree.bpmn20.xml")
                .deploy();
