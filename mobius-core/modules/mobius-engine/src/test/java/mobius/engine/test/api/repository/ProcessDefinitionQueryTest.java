...
public class ProcessDefinitionQueryTest extends PluggableFlowableTestCase {
    ...
    protected void setUp() throws Exception {
        deploymentOneId = repositoryService.createDeployment().name("mobius/engine/test/repository/one.bpmn20.xml").addClasspathResource("mobius/engine/test/repository/one.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/repository/two.bpmn20.xml").deploy().getId();

        deploymentTwoId = repositoryService.createDeployment().name("mobius/engine/test/repository/one.bpmn20.xml").addClasspathResource("mobius/engine/test/repository/one.bpmn20.xml")
                .deploy().getId();
    ...
    public void testQueryByMessageSubscription() {
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/repository/processWithNewBookingMessage.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/repository/processWithNewInvoiceMessage.bpmn20.xml").deploy();
