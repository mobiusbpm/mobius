...
public class ProcessDefinitionSuspensionTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/db/processOne.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/db/processOne.bpmn20.xml", "mobius/engine/test/db/processTwo.bpmn20.xml" })
    ...
    public void testSuspendMultipleProcessDefinitionsByKey() {
        ...
        for (int i = 0; i < nrOfProcessDefinitions; i++) {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess.bpmn20.xml").deploy();
        }
