...
public class ExecutionAndProcessInstanceQueryVersionTest extends PluggableFlowableTestCase {
    ...
    private static final String DEPLOYMENT_FILE_PATH = "mobius/engine/test/api/runtime/oneTaskProcess.bpmn20.xml";

    private mobius.engine.repository.Deployment oldDeployment;
    private mobius.engine.repository.Deployment newDeployment;
