...
public class ExecutionQueryTest extends PluggableFlowableTestCase {
    ...
    private static final String CONCURRENT_PROCESS_CATEGORY = "mobius.engine.test.api.runtime.concurrent.Category";
    private static final String SEQUENTIAL_PROCESS_CATEGORY = "mobius.engine.test.api.runtime.Category";
    ...
    protected void setUp() throws Exception {
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/runtime/concurrentExecution.bpmn20.xml").deploy();
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/concurrentExecution.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/executionLocalization.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/multipleSubProcess.bpmn20.xml",
