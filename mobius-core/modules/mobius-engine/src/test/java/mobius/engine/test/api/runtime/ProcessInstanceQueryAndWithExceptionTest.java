...
public class ProcessInstanceQueryAndWithExceptionTest extends PluggableFlowableTestCase {
    ...
    protected void setUp() throws Exception {
        deployment = repositoryService.createDeployment()
                ...
                .addClasspathResource("mobius/engine/test/api/runtime/JobErrorCheck.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/runtime/JobErrorDoubleCheck.bpmn20.xml")
                .deploy();
    }
