...
public class ProcessInstanceQueryTest extends PluggableFlowableTestCase {
    ...
    private static final String PROCESS_DEFINITION_CATEGORY = "mobius.engine.test.api.runtime.Category";
    private static final String PROCESS_DEFINITION_CATEGORY_2 = "mobius.engine.test.api.runtime.2Category";

    private mobius.engine.repository.Deployment deployment;
    ...
    protected void setUp() throws Exception {
        deployment = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/api/runtime/oneTaskProcess2.bpmn20.xml").deploy();
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/superProcess.bpmn20.xml", "mobius/engine/test/api/runtime/subProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml", "mobius/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
            "mobius/engine/test/api/runtime/subProcess.bpmn20.xml" })
    ...
    @Deployment(resources = {
            "mobius/engine/test/api/oneTaskProcess.bpmn20.xml" })
    ...
    public void testLocalizeProcess() throws Exception {
        ...
        dynamicBpmnService.changeLocalizationName("en-GB", "oneTaskProcess", "The One mobius.task.service.Task Process 'en-GB' localized name", infoNode);
        dynamicBpmnService.changeLocalizationDescription("en-GB", "oneTaskProcess", "The One mobius.task.service.Task Process 'en-GB' localized description", infoNode);
        dynamicBpmnService.saveProcessDefinitionInfo(processInstance.getProcessDefinitionId(), infoNode);

        dynamicBpmnService.changeLocalizationName("en", "oneTaskProcess", "The One mobius.task.service.Task Process 'en' localized name", infoNode);
        dynamicBpmnService.changeLocalizationDescription("en", "oneTaskProcess", "The One mobius.task.service.Task Process 'en' localized description", infoNode);
        dynamicBpmnService.saveProcessDefinitionInfo(processInstance.getProcessDefinitionId(), infoNode);
        ...
        assertEquals(1, processes.size());
        assertEquals("The One mobius.task.service.Task Process 'en-GB' localized name", processes.get(0).getName());
        assertEquals("The One mobius.task.service.Task Process 'en-GB' localized description", processes.get(0).getDescription());
        ...
        assertEquals("The One mobius.task.service.Task Process 'en-GB' localized name", processInstance.getName());
        assertEquals("The One mobius.task.service.Task Process 'en-GB' localized description", processInstance.getDescription());
        ...
        assertEquals("The One mobius.task.service.Task Process 'en' localized name", processInstance.getName());
        assertEquals("The One mobius.task.service.Task Process 'en' localized description", processInstance.getDescription());
