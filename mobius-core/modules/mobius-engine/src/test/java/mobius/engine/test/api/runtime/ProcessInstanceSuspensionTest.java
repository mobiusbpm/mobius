...
public class ProcessInstanceSuspensionTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/superProcessWithMultipleNestedSubProcess.bpmn20.xml", "mobius/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/runtime/ProcessInstanceSuspensionTest.testSignalEventReceivedAfterProcessInstanceSuspended.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/runtime/ProcessInstanceSuspensionTest.testJobNotExecutedAfterProcessInstanceSuspend.bpmn20.xml")
