...
import mobius.engine.impl.persistence.entity.ActivityInstanceEntity;
...
import mobius.engine.runtime.ActivityInstanceQuery;
...
public class RuntimeActivityInstanceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/history/oneTaskProcessWithoutSequenceFlowIds.bpmn20.xml")
    ...
    @Test
    @Deployment(resources= "mobius/engine/test/api/runtime/RuntimeActivityInstanceTest.testActivityInstanceNoop.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/history/HistoricActivityInstanceTest.testHistoricActivityInstanceProperties.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/history/calledProcess.bpmn20.xml", "mobius/engine/test/api/runtime/RuntimeActivityInstanceTest.testCallSimpleSubProcess.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = "mobius/engine/test/history/HistoricActivityInstanceTest.testParallelJoinEndTime.bpmn20.xml")
