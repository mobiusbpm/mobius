...
public class RuntimeServiceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/oneSubProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/RuntimeServiceTest.catchAlertSignal.bpmn20.xml",
        "mobius/engine/test/api/runtime/RuntimeServiceTest.catchPanicSignal.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/runtime/RuntimeServiceTest.catchAlertMessage.bpmn20.xml",
        "mobius/engine/test/api/runtime/RuntimeServiceTest.catchPanicMessage.bpmn20.xml" })
