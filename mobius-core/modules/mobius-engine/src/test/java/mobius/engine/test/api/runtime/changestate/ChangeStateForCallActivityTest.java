...
public class ChangeStateForCallActivityTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/twoTasksParentProcess.bpmn20.xml", "mobius/engine/test/api/oneTaskProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/twoTasksParentProcessV2.bpmn20.xml", "mobius/engine/test/api/twoTasksProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/variables/callActivityWithCalledElementExpression.bpmn20.xml" })
    ...
    public void testSetCurrentActivityInSubProcessInstanceSpecificVersion() {
        ...
        //Deploy second version of the process definition
        deployProcessDefinition("my deploy", "mobius/engine/test/api/oneTaskProcessV2.bpmn20.xml");
