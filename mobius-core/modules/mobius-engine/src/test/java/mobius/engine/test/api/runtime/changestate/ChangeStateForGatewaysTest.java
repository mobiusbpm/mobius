...
public class ChangeStateForGatewaysTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/inclusiveGatewayForkJoin.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/parallelSubProcesses.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/parallelSubProcessesMultipleTasks.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/multipleParallelSubProcesses.bpmn20.xml" })
