...
public class ChangeStateForMultiInstanceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/multiInstanceSequential.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/multiInstanceParallel.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/multiInstanceParallelSubProcess.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/multiInstanceNestedParallelSubProcesses.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/parallelGatewayInsideMultiInstanceSubProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/inclusiveGatewayNestedInsideMultiInstanceSubProcess.bpmn20.xml" })
