...
import mobius.engine.impl.migration.ProcessInstanceMigrationDocumentImpl;
...
public class ProcessInstanceMigrationDocumentTest extends AbstractTestCase {
    ...
    public void testDeSerializeCompleteProcessInstanceMigrationDocument() {
        ...
        String jsonAsStr = IoUtil.readFileAsString("mobius/engine/test/api/runtime/migration/completeProcessInstanceMigrationDocument.json");
    ...
    public void testDeSerializeDuplicatedFromActivity() {
        ...
        String jsonAsStr = IoUtil.readFileAsString("mobius/engine/test/api/runtime/migration/duplicatedFromActivitiesInFromMappingMigrationDocument.json");
    ...
    public void testDeSerializeWithCallActivityProcessInstanceMigrationDocument() {
        ...
        String jsonAsStr = IoUtil.readFileAsString("mobius/engine/test/api/runtime/migration/withCallActivityProcessInstanceMigrationDocument.json");
