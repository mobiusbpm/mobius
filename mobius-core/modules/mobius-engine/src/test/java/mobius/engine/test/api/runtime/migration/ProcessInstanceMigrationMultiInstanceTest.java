...
public class ProcessInstanceMigrationMultiInstanceTest extends AbstractProcessInstanceMigrationTest {
    ...
    public void testMigrateActivityToSequentialMultiInstanceActivity() {
        ProcessDefinition procSimpleOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procSequentialMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/sequential-multi-instance-task.bpmn20.xml");
    ...
    public void testMigrateActivityToParallelMultiInstanceActivity() {
        ProcessDefinition procSimpleOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procParallelMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/parallel-multi-instance-task.bpmn20.xml");
    ...
    public void testMigrateActivityToSequentialMultiInstanceSubProcess() {
        ProcessDefinition procSimpleOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procSequentialMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/sequential-multi-instance-subprocess.bpmn20.xml");
    ...
    public void testMigrateActivityToParallelMultiInstanceSubProcess() {
        ProcessDefinition procSimpleOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procParallelMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/parallel-multi-instance-subprocess.bpmn20.xml");
    ...
    public void testMigrateNestedSequentialMultiInstanceSubProcessActivityToOuterSequentialSubProcessActivity() {
        ProcessDefinition procNestedSequentialMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/nested-sequential-multi-instance-subprocesses.bpmn20.xml");
        ProcessDefinition procSequentialMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/sequential-multi-instance-subprocess.bpmn20.xml");
    ...
    public void testMigrateNestedParallelMultiInstanceSubProcessActivityToOuterParallelSubProcessActivity() {
        ProcessDefinition procNestedParallelMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/nested-parallel-multi-instance-subprocesses.bpmn20.xml");
        ProcessDefinition procParallelMultiInst = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/parallel-multi-instance-subprocess.bpmn20.xml");
