...
import mobius.engine.delegate.event.FlowableActivityEvent;
import mobius.engine.delegate.event.FlowableMessageEvent;
import mobius.engine.delegate.event.FlowableSignalEvent;
...
import mobius.engine.migration.ProcessInstanceMigrationDocumentConverter;
...
import mobius.engine.test.api.runtime.changestate.ChangeStateEventListener;
...
public class ProcessInstanceMigrationTest extends AbstractProcessInstanceMigrationTest {
    ...
    public void testSimpleMigrationWithActivityAutoMapping() {
        ...
        ProcessDefinition version1ProcessDef = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ...
        ProcessDefinition version2ProcessDef = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/two-tasks-simple-process.bpmn20.xml");
    ...
    public void testSimpleMigrationWithTaskMapping() {
        //Deploy first version of the process
        deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/two-tasks-simple-process.bpmn20.xml");
        ...
        //Deploy second version of the process
        ProcessDefinition version2ProcessDef = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/three-tasks-simple-process.bpmn20.xml");
    ...
    public void testMigrationWithParallelTaskMapping() {
        //Deploy first version of the process
        deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/parallel-gateway-two-tasks.bpmn20.xml");
        ...
        //Deploy second version of the process
        ProcessDefinition version2ProcessDef = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/parallel-gateway-two-tasks-and-before.bpmn20.xml");
    ...
    public void testMigrationWithNewSubProcessScope() {
        ...
        //Deploy second version of the process
        ProcessDefinition version2ProcessDef = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/three-tasks-with-sub-process.bpmn20.xml");
    ...
    public void testSimpleMigrationWithExplicitActivityMapping1() {
        ...
        Deployment oneActivityProcessDeployment = repositoryService.createDeployment()
            ...
            .addClasspathResource("mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml")
            .deploy();
        ...
        Deployment twoActivitiesProcessDeployment = repositoryService.createDeployment()
            .name("My Process Deployment")
            .addClasspathResource("mobius/engine/test/api/runtime/migration/two-tasks-simple-process.bpmn20.xml")
            .deploy();
    ...
    public void testSimpleMigrationWithinSimpleSubProcess() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-tasks-inside-subprocess.bpmn20.xml");
        ProcessDefinition procDefTwoTasks = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/two-tasks-inside-subprocess.bpmn20.xml");
    ...
    public void testMigrateActivityFromProcessRootIntoNestedEmbeddedSubProcess() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-tasks-inside-subprocess.bpmn20.xml");
        ProcessDefinition procDefNested = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-tasks-nested-subprocess.bpmn20.xml");
    ...
    public void testMigrateActivityFromProcessRootIntoNestedEmbeddedSubProcessWithDataObject() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-tasks-inside-subprocess-with-data-object.bpmn20.xml");
        ProcessDefinition procDefNested = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-tasks-nested-subprocess-with-data-object.bpmn20.xml");
    ...
    public void testMigrateActivityToActivityWithTimerInNewDefinition() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procDefOWithTimer = deployProcessDefinition("my deploy", "mobius/engine/test/api/twoTasksProcessWithTimer.bpmn20.xml");
    ...
    public void testMigrateActivityWithTimerToActivityWithTimerInNewDefinition() {
        ProcessDefinition procDefOneTimer = deployProcessDefinition("my deploy", "mobius/engine/test/api/twoTasksProcessWithTimer.bpmn20.xml");
        ProcessDefinition procDefTwoTimers = deployProcessDefinition("my deploy", "mobius/engine/test/api/twoTasksProcessWithTimers.bpmn20.xml");
    ...
    public void testMigrateActivityInsideEmbeddedSubProcessWithTimerToActivityOutsideEmbeddedSubProcessWithoutTimerInNewDefinition() {
        ProcessDefinition procDefSubProcWithTimer = deployProcessDefinition("my deploy", "mobius/engine/test/api/oneTaskSubProcessWithTimer.bpmn20.xml");
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
    ...
    public void testMigrateActivityWithTimerInsideEmbeddedSubProcessToActivityWithoutTimerInsideEmbeddedSubProcessInNewDefinition() {
        ProcessDefinition procVersion1 = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-with-timer-inside-embedded-subprocess.bpmn20.xml");
        ProcessDefinition procVersion2 = deployProcessDefinition("my deploy", "mobius/engine/test/api/oneTaskWithTimerInSubProcess.bpmn20.xml");
    ...
    public void testMigrateActivityToActivityWithTimerInsideEmbeddedSubProcessInNewDefinition() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procDefTimerTaskInSubProcess = deployProcessDefinition("my deploy", "mobius/engine/test/api/oneTaskWithTimerInSubProcess.bpmn20.xml");
    ...
    public void testMigrateSimpleActivityToIntermediateSignalCatchingEventInNewDefinition() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procWithSignal = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/changestate/RuntimeServiceChangeStateTest.simpleIntermediateSignalCatchEvent.bpmn20.xml");
    ...
    public void testMigrateIntermediateSignalCatchingEventToIntermediateSignalCatchingEventInNewDefinition() {
        ProcessDefinition procWithSignalVer1 = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/changestate/RuntimeServiceChangeStateTest.simpleIntermediateSignalCatchEvent.bpmn20.xml");
        ProcessDefinition procWithSignalVer2 = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/simple-intermediate-signal-catch-event.bpmn20.xml");
    ...
    public void testMigrateSimpleActivityToIntermediateMessageCatchingEventInNewDefinition() {
        ProcessDefinition procDefOneTask = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/one-task-simple-process.bpmn20.xml");
        ProcessDefinition procWithSignal = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/changestate/RuntimeServiceChangeStateTest.simpleIntermediateMessageCatchEvent.bpmn20.xml");
    ...
    public void testMigrateIntermediateMessageCatchingEventToIntermediateMessageCatchingEventInNewDefinition() {
        ProcessDefinition procWithSignalVer1 = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/changestate/RuntimeServiceChangeStateTest.simpleIntermediateMessageCatchEvent.bpmn20.xml");
        ProcessDefinition procWithSignalVer2 = deployProcessDefinition("my deploy", "mobius/engine/test/api/runtime/migration/simple-intermediate-message-catch-event.bpmn20.xml");
