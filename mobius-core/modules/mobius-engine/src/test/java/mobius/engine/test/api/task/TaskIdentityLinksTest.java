...
public class TaskIdentityLinksTest extends PluggableFlowableTestCase {
    ...
    private static final String IDENTITY_LINKS_PROCESS_BPMN20_XML = "mobius/engine/test/api/task/IdentityLinksProcess.bpmn20.xml";
    private static final String IDENTITY_LINKS_PROCESS = "IdentityLinksProcess";

    @Test
    @Deployment(resources = "mobius/engine/test/api/task/IdentityLinksProcess.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/task/TaskIdentityLinksTest.testDeleteCandidateUser.bpmn20.xml")
