...
import mobius.identitylink.api.IdentityLinkInfo;
...
public class TaskQueryTest extends PluggableFlowableTestCase {
    ...
    public void testQueryByInvolvedGroupOrAssignee() {
        try {
            Task adhocTask = taskService.newTask();
            taskService.saveTask(adhocTask);
            Task adhocTask2 = taskService.newTask();
            adhocTask2.setAssignee("kermit");
            taskService.saveTask(adhocTask2);
            Task adhocTask3 = taskService.newTask();
    ...
    public void testQueryByInvolvedGroupTaskName() {
        try {
            ...
            Task adhocTask3 = taskService.newTask();
            taskService.saveTask(adhocTask3);
            Task adhocTask4 = taskService.newTask();
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/task/taskDefinitionProcess.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/task/TaskQueryTest.testTaskVariableValueEquals.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/api/task/TaskQueryTest.testProcessVariableValueEquals.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/api/task/TaskQueryTest.testProcessDefinition.bpmn20.xml")
    ...
    public void testNativeQueryPaging() {
        assertEquals("ACT_RU_TASK", managementService.getTableName(Task.class, false));
    ...
    public void testNativeQuery() {
        ...
        assertEquals(12, taskService.createNativeTaskQuery().sql("SELECT count(*) FROM " + managementService.getTableName(
				Task.class)).count());
        ...
        assertEquals(1, taskService.createNativeTaskQuery().sql("SELECT count(*) FROM " + managementService.getTableName(
				Task.class) + " T WHERE T.NAME_ = 'gonzoTask'").count());
