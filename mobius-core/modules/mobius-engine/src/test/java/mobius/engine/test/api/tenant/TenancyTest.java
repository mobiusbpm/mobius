 ...
 */
package mobius.engine.test.api.tenant;
...
public class TenancyTest extends PluggableFlowableTestCase {
    ...
    public void testJobTenancy() {
        ...
        String deploymentId = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testJobTenancy.bpmn20.xml").tenantId(TEST_TENANT_ID).deploy()
                .getId();
        ...
        String deploymentId2 = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testJobTenancy.bpmn20.xml").deploy().getId();
    ...
    public void testSignalFromProcessTenancy() {
        ...
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testMultiTenancySignals.bpmn20.xml").deploy();
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testMultiTenancySignals.bpmn20.xml").tenantId(TEST_TENANT_ID).deploy();
    ...
    public void testStartProcessInstanceBySignalTenancy() {
        ...
        // Deploy process both with and without tenant
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testStartProcessInstanceBySignalTenancy.bpmn20.xml").deploy();
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testStartProcessInstanceBySignalTenancy.bpmn20.xml").tenantId(TEST_TENANT_ID).deploy();
    ...
    public void testStartProcessInstanceByMessageTenancy() {
        ...
        // Deploy process both with and without tenant
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testMessageTenancy.bpmn20.xml").deploy();
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testMessageTenancy.bpmn20.xml").tenantId(TEST_TENANT_ID).deploy();
    ...
    public void testCallActivityWithTenant() {
        if (HistoryTestHelper.isHistoryLevelAtLeast(HistoryLevel.ACTIVITY, processEngineConfiguration)) {
            ...
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testCallActivityWithTenant-process01.bpmn20.xml").tenantId(tenantId).deploy();
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/tenant/TenancyTest.testCallActivityWithTenant-process02.bpmn20.xml").tenantId(tenantId).deploy();
