 ...
 */
package mobius.engine.test.api.variables;
...
public class VariablesTest extends PluggableFlowableTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/api/variables/VariablesTest.bpmn20.xml").deploy();
