 ...
 */
package mobius.engine.test.bpmn;
...
public class StartToEndTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/StartToEndTest.testStartToEnd.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/StartToEndTest.testStartWithServiceTask.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/StartToEndTest.testStartWithSerializableVariables.bpmn20.xml" })
