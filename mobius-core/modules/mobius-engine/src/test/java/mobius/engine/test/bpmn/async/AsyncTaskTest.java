 ...
 */
package mobius.engine.test.bpmn.async;
...
public class AsyncTaskTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/async/AsyncTaskTest.testAsyncCallActivity.bpmn20.xml",
            "mobius/engine/test/bpmn/async/AsyncTaskTest.testAsyncServiceNoListeners.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/async/AsyncTaskTest.testBasicAsyncCallActivity.bpmn20.xml", "mobius/engine/test/bpmn/StartToEndTest.testStartToEnd.bpmn20.xml" })
