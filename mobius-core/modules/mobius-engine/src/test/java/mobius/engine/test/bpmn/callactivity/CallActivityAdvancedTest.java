...
public class CallActivityAdvancedTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithExpressions.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testSubProcessEndsSuperProcess.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallParallelSubProcess.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleParallelSubProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSequentialSubProcess.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithExpressions.bpmn20.xml", "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess2.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testTimerOnCallActivity.bpmn20.xml", "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testSubProcessDataInputOutput.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testTwoSubProcesses.bpmn20.xml", "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
    ...
    @Deployment(resources = {
            "mobius/engine/test/bpmn/callactivity/CallActivity.testStartUserIdSetWhenLooping.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
    })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml", "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { 
            "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcess.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
            })
    ...
    @Test
    @Deployment(resources = {
        "mobius/engine/test/bpmn/callactivity/callActivityInEmbeddedSubProcess.bpmn20.xml",
        "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
    })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithFallback.bpmn20.xml"},
        tenantId = "flowable"
    )
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithFallbackWrongNonBoolean.bpmn20.xml",
        "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"},
        tenantId = "flowable"
    )
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/callactivity/CallActivity.testCallSimpleSubProcessWithFallbackFalse.bpmn20.xml",
        "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"},
        tenantId = "flowable"
    )
    ...
    @Test
    @Deployment(resources = {
            "mobius/engine/test/bpmn/callactivity/CallActivity.testAsyncSequentialMiCallActivity.bpmn20.xml",
            "mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
    })
    ...
    protected void assertCallActivityToFallback() {
        mobius.engine.repository.Deployment deployment = this.repositoryService.createDeployment().
            addClasspathResource("mobius/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml").
