...
package mobius.engine.test.bpmn.deployment;
...
public class BpmnDeploymentTest extends PluggableFlowableTestCase {
    ...
    public void testGetBpmnXmlFileThroughService() {
        ...
        String bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testGetBpmnXmlFileThroughService.bpmn20.xml";
        ...
        InputStream fileInputStream = ReflectUtil.getResourceAsStream(
                "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testGetBpmnXmlFileThroughService.bpmn20.xml");
    ...
    public void testViolateBPMNIdMaximumLength() {
        try {
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/deployment/definitionWithLongTargetNamespace.bpmn20.xml")
                    .deploy();
            fail();
    ...
    public void testViolateProcessDefinitionIdMaximumLength() {
        try {
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/deployment/processWithLongId.bpmn20.xml")
                    .deploy();
            fail();
        } catch (FlowableException e) {
    ...
    public void testViolateProcessDefinitionNameAndDescriptionMaximumLength() {
        try {
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/deployment/processWithLongNameAndDescription.bpmn20.xml")
                    .deploy();
            fail();
        } catch (FlowableException e) {
    ...
    public void testViolateDefinitionTargetNamespaceMaximumLength() {
        try {
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.definitionWithLongTargetNamespace.bpmn20.xml")
                    .deploy();
            fail();
        } catch (FlowableException e) {
            assertTextPresent(Problems.BPMN_MODEL_TARGET_NAMESPACE_TOO_LONG, e.getMessage());
    ...
    public void testDeploySameFileTwice() {
        ...
        repositoryService.createDeployment().enableDuplicateFiltering().addClasspathResource(bpmnResourceName).name("twice").deploy();
        List<mobius.engine.repository.Deployment> deploymentList = repositoryService.createDeploymentQuery().list();
    ...
    public void testDeploySameFileTwiceAfterInitialDeployment() {
        String bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.bpmn20.xml";
        repositoryService.createDeployment().enableDuplicateFiltering().addClasspathResource(bpmnResourceName).name("twice").deploy();
        
        bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testGetBpmnXmlFileThroughService.bpmn20.xml";
        repositoryService.createDeployment().enableDuplicateFiltering().addClasspathResource(bpmnResourceName).name("twice").deploy();

        List<mobius.engine.repository.Deployment> deploymentList = repositoryService.createDeploymentQuery().orderByDeploymenTime().desc().list();
        ...
        for (mobius.engine.repository.Deployment deployment : deploymentList) {
    ...
    public void testDeployTwoProcessesWithDuplicateIdAtTheSameTime() {
        String bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testGetBpmnXmlFileThroughService.bpmn20.xml";
        String bpmnResourceName2 = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testGetBpmnXmlFileThroughService2.bpmn20.xml";
    ...
    public void testDeployDifferentFiles() {
        ...
        bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.bpmn20.xml";
        repositoryService.createDeployment().enableDuplicateFiltering().addClasspathResource(bpmnResourceName).name("twice").deploy();
        List<mobius.engine.repository.Deployment> deploymentList = repositoryService.createDeploymentQuery().list();
        assertEquals(2, deploymentList.size());
    ...
    public void testStartFormKey() {
        ...
        // verify bpmn file name
        assertEquals(1, deploymentResources.size());
        String bpmnResourceName = "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testStartFormKey.bpmn20.xml";
        assertEquals(bpmnResourceName, deploymentResources.get(0));
    ...
    public void testDiagramCreationDisabled() {
        ...
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/parse/BpmnParseTest.testParseDiagramInterchangeElements.bpmn20.xml").deploy();
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.bpmn20.xml",
            "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.jpg" })
    public void testProcessDiagramResource(@DeploymentId String deploymentIdFromDeploymentAnnotation) {
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().singleResult();

        assertEquals("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.bpmn20.xml", processDefinition.getResourceName());
        BpmnModel processModel = repositoryService.getBpmnModel(processDefinition.getId());
        ...
        assertEquals("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testProcessDiagramResource.jpg", diagramResourceName);
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.bpmn20.xml",
            "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.a.jpg",
            "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.b.jpg",
            "mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.c.jpg" })
    public void testMultipleDiagramResourcesProvided() {
        ...
        assertEquals("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.a.jpg", processA.getDiagramResourceName());
        assertEquals("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.b.jpg", processB.getDiagramResourceName());
        assertEquals("mobius/engine/test/bpmn/deployment/BpmnDeploymentTest.testMultipleDiagramResourcesProvided.c.jpg", processC.getDiagramResourceName());
    }
