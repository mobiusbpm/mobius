...
public class TimerEventsAndNewVersionDeploymentsTest extends PluggableFlowableTestCase {
    ...
    private static final String TEST_TIMER_PROCESS = "mobius/engine/test/bpmn/deployment/TimerEventsAndNewVersionDeploymentsTest.timerTest.bpmn20.xml";

    private static final String TEST_PROCESS_NO_TIMER = "mobius/engine/test/bpmn/deployment/TimerEventsAndNewVersionDeploymentsTest.processWithoutEvents.bpmn20.xml";
