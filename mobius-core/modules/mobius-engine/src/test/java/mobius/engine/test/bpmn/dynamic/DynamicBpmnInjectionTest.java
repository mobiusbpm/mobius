 ...
 */
package mobius.engine.test.bpmn.dynamic;
...
public class DynamicBpmnInjectionTest extends PluggableFlowableTestCase {
    ...
    public void testInjectParallelSubProcessSimple() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/dynamic/dynamic_onetask.bpmn20.xml")
                .deploy();
    ...
    public void testInjectParallelSubProcessComplex() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/dynamic/dynamic_test_process01.bpmn")
                .addClasspathResource("mobius/engine/test/bpmn/dynamic/dynamic_test_process02.bpmn")
                .deploy();
