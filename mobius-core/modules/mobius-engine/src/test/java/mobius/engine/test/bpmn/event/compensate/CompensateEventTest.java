...
package mobius.engine.test.bpmn.event.compensate;
...
import mobius.engine.test.EnableVerboseExecutionTreeLogging;
...
public class CompensateEventTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.SubProcess1.bpmn20.xml",
            "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.SubProcess2.bpmn20.xml",
            "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testCompensateTwoSubprocesses.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testCallActivityCompensationHandler.bpmn20.xml",
            "mobius/engine/test/bpmn/event/compensate/CompensationHandler.bpmn20.xml" })
    ...
    public void testMultipleCompensationCatchEventsFails() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testMultipleCompensationCatchEventsFails.bpmn20.xml").deploy();
    ...
    public void testInvalidActivityRefFails() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testInvalidActivityRefFails.bpmn20.xml").deploy();
            fail("exception expected");
        } catch (Exception e) {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testCompensationStepEndRecorded.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/compensate/CompensateEventTest.testCompensateWithSubprocess.bpmn20.xml" })
