...
public class BoundaryConditionalEventTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/event/conditional/BoundaryConditionalEventTest.testCatchConditionalOnEmbeddedSubprocess.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/event/conditional/BoundaryConditionalEventTest.testCatchNonInterruptingConditionalOnEmbeddedSubprocess.bpmn20.xml")
