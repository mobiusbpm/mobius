...
public class ErrorEventSubProcessTest extends PluggableFlowableTestCase {
    ...
    public void testErrorCodeTakesPrecedence() {
        ...
        // The process will throw an error event, which is caught and escalated by a User mobius.task.service.Task
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/error/ErrorEventSubProcessTest.testThrowErrorInScriptTaskInsideCallActivitiCatchInTopLevelProcess.bpmn20.xml",
    ...
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/event/error/ErrorEventSubProcessTest.testCatchMultipleRethrowParent.bpmn",
                    "mobius/engine/test/bpmn/event/error/ErrorEventSubProcessTest.testCatchMultipleRethrowSubProcess.bpmn"})
