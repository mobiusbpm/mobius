...
public class MessageBoundaryEventTest extends PluggableFlowableTestCase {
    ...
    public void testDoubleBoundaryMessageEventSameMessageId() {
        ...
        // messageId
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/message/MessageBoundaryEventTest.testDoubleBoundaryMessageEventSameMessageId.bpmn20.xml").deploy();
