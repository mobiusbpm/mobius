...
public class SignalEventSubprocessTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources="mobius/engine/test/bpmn/event/signal/SignalEventSubprocessTest.testStartingAdditionalTasks.bpmn20.xml")
    ...
    @Test
    @Deployment(resources="mobius/engine/test/bpmn/event/signal/SignalEventSubprocessTest.testStartingAdditionalTasksInterrupting.bpmn20.xml")
