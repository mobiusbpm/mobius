...
package mobius.engine.test.bpmn.event.signal;
...
public class SignalEventTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchAlertSignal.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignal.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchAlertSignalExpression.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignalExpression.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchAlertSignalBoundary.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignal.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignal.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchAlertSignal.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignalAsynch.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/event/signal/SignalEventTests.catchMultipleSignals.bpmn20.xml",
            "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignal.bpmn20.xml", "mobius/engine/test/bpmn/event/signal/SignalEventTests.throwAbortSignal.bpmn20.xml" })
    ...
    public void testDuplicateSignalNames() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTests.duplicateSignalNames.bpmn20.xml").deploy();
    ...
    public void testNoSignalName() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTests.noSignalName.bpmn20.xml").deploy();
            fail("exception expected");
        } catch (Exception e) {
    ...
    public void testSignalNoId() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTests.signalNoId.bpmn20.xml").deploy();
            fail("exception expected");
        } catch (Exception e) {
    ...
    public void testSignalNoRef() {
        try {
            repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTests.signalNoRef.bpmn20.xml").deploy();
            fail("exception expected");
        } catch (Exception e) {
    ...
    public void testSignalStartEventFromProcess() {
        ...
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTest.testSignalStartEvent.bpmn20.xml").deploy();
    ...
    public void testSignalStartEventFromProcesAsync() {
        ...
        // Deploy test processes
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/signal/SignalEventTest.testSignalStartEventAsync.bpmn20.xml").deploy();
