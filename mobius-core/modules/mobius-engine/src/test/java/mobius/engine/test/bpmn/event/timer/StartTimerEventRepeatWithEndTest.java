...
public class StartTimerEventRepeatWithEndTest extends PluggableFlowableTestCase {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        // deploy the process
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventRepeatWithEndTest.testCycleDateStartTimerEvent.bpmn20.xml").deploy();
