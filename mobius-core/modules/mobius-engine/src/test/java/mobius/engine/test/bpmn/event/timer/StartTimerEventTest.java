...
public class StartTimerEventTest extends PluggableFlowableTestCase {
    ...
    public void testOldJobsDeletedOnRedeploy() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testOldJobsDeletedOnRedeploy.bpmn20.xml")
                    .deploy();
    ...
    public void testTimersRecreatedOnDeploymentDelete() {
        ...
        // Deploy v1
        repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testTimersRecreatedOnDeploymentDelete_v1.bpmn20.xml")
                .deploy().getId();
        ...
        String deployment2 = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testTimersRecreatedOnDeploymentDelete_v2.bpmn20.xml")
                .deploy().getId();
        ...
        String deployment3 = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testTimersRecreatedOnDeploymentDelete_v3.bpmn20.xml")
                .deploy().getId();
        ...
        String deployment4 = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testTimersRecreatedOnDeploymentDelete_v4.bpmn20.xml")
                .deploy().getId();
    ...
    public void testTimersRecreatedOnDeploymentDeleteWithTenantId() {
        ...
        for (int i = 1; i <= 4; i++) {
            repositoryService.createDeployment()
                    .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testTimersRecreatedOnDeploymentDelete_v" + i + ".bpmn20.xml")
                    .deploy();
        }
    ...
    public void testMultipleStartEvents() {
        ...
        String deploymentId = repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventTest.testMultipleStartEvents.bpmn20.xml")
                .deploy().getId();
