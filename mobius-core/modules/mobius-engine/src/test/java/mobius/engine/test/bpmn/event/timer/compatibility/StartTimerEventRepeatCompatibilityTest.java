 ...
 */
package mobius.engine.test.bpmn.event.timer.compatibility;
...
import mobius.engine.test.api.event.TestFlowableEntityEventListener;
...
public class StartTimerEventRepeatCompatibilityTest extends TimerEventCompatibilityTest {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        // deploy the process
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/bpmn/event/timer/StartTimerEventRepeatWithoutEndDateTest.testCycleDateStartTimerEvent.bpmn20.xml").deploy();
