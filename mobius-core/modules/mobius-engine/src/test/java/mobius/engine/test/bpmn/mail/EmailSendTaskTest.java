...
public class EmailSendTaskTest extends EmailTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailSendTaskTest.testSimpleTextMailMultipleRecipients.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailSendTaskTest.testCcAndBcc.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailSendTaskTest.testMissingToAddress.bpmn20.xml")
