...
package mobius.engine.test.bpmn.mail;
...
public class EmailServiceTaskTest extends EmailTestCase {
    ...
    @Test
    @Deployment(resources="mobius/engine/test/bpmn/mail/EmailServiceTaskTest.testSkipExpression.bpmn20.xml")
    ...
    public void testSimpleTextMailWhenMultiTenant() throws Exception {
        ...
        repositoryService.createDeployment()
                .addClasspathResource("mobius/engine/test/bpmn/mail/EmailSendTaskTest.testSimpleTextMail.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailSendTaskTest.testSimpleTextMail.bpmn20.xml", tenantId = "forceToEmailTenant")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailServiceTaskTest.testSimpleTextMailMultipleRecipients.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailServiceTaskTest.testCcAndBcc.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/mail/EmailServiceTaskTest.testMissingToAddress.bpmn20.xml")
