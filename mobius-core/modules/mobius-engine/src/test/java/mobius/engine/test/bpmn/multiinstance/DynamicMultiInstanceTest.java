...
public class DynamicMultiInstanceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/multiinstance/DynamicMultiInstanceTest.testParallelUserTasks.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = {"mobius/engine/test/bpmn/multiinstance/DynamicMultiInstanceTest.testSequentialSubProcessCompletionCondition.bpmn20.xml"})
