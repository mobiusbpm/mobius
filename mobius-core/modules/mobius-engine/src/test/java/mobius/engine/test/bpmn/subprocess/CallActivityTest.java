...
package mobius.engine.test.bpmn.subprocess;
...
import mobius.engine.interceptor.StartProcessInstanceAfterContext;
import mobius.engine.interceptor.StartProcessInstanceBeforeContext;
import mobius.engine.interceptor.StartProcessInstanceInterceptor;
...
public class CallActivityTest extends ResourceFlowableTestCase {
    ...
    private static final String MAIN_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSuspendedProcessCallActivity_mainProcess.bpmn.xml";
    private static final String CHILD_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSuspendedProcessCallActivity_childProcess.bpmn.xml";
    private static final String MESSAGE_TRIGGERED_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSuspendedProcessCallActivity_messageTriggeredProcess.bpmn.xml";
    private static final String INHERIT_VARIABLES_MAIN_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testInheritVariablesCallActivity_mainProcess.bpmn20.xml";
    private static final String INHERIT_VARIABLES_CHILD_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSameDeploymentCallActivity_childProcess.bpmn20.xml";
    private static final String SAME_DEPLOYMENT_MAIN_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSameDeploymentCallActivity_mainProcess.bpmn20.xml";
    private static final String SAME_DEPLOYMENT_CHILD_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSameDeploymentCallActivity_childProcess.bpmn20.xml";
    private static final String SAME_DEPLOYMENT_CHILD_V2_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testSameDeploymentCallActivity_childProcess_v2.bpmn20.xml";
    private static final String NOT_SAME_DEPLOYMENT_MAIN_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testNotSameDeploymentCallActivity_mainProcess.bpmn20.xml";
    private static final String NOT_INHERIT_VARIABLES_MAIN_PROCESS_RESOURCE = "mobius/engine/test/bpmn/subprocess/SubProcessTest.testNotInheritVariablesCallActivity_mainProcess.bpmn20.xml";
