...
package mobius.engine.test.bpmn.subprocess.adhoc;
...
public class AdhocSubProcessTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/bpmn/subprocess/adhoc/AdhocSubProcessTest.testFlowsInAdhocSubProcess.bpmn20.xml")
