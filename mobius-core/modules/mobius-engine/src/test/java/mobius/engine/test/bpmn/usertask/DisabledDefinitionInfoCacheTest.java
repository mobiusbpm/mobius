...
public class DisabledDefinitionInfoCacheTest extends ResourceFlowableTestCase {
    ...
    public DisabledDefinitionInfoCacheTest() {
        super("mobius/engine/test/bpmn/usertask/flowable.cfg.xml");
    }
    ...
    public void testChangeClassName() {
        ...
        String processDefinitionId = processInstance.getProcessDefinitionId();
        ObjectNode infoNode = dynamicBpmnService.changeServiceTaskClassName("service", "mobius.engine.test.bpmn.servicetask.DummyServiceTask2");
        dynamicBpmnService.saveProcessDefinitionInfo(processDefinitionId, infoNode);
