...
public class DynamicUserTaskTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/usertask/DynamicUserTaskTest.assignment.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/bpmn/usertask/DynamicUserTaskTest.basictask.bpmn20.xml" })
