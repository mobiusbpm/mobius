...
import mobius.engine.interceptor.CreateUserTaskInterceptor;
...
public class UserTaskTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources="mobius/engine/test/bpmn/usertask/UserTaskTest.testTaskPropertiesNotNull.bpmn20.xml")
