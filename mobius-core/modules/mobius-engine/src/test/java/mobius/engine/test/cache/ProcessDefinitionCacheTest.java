...
package mobius.engine.test.cache;
...
public class ProcessDefinitionCacheTest extends AbstractTestCase {
    ...
    public void testStartProcessInstanceByIdAfterReboot() {
        ...
        processEngine.getRepositoryService().createDeployment().addClasspathResource("mobius/engine/test/cache/originalProcess.bpmn20.xml").deploy();
        ...
        processEngine = new StandaloneProcessEngineConfiguration().setEngineName("reboot-test").setDatabaseSchemaUpdate(
				mobius.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_FALSE)
                .setJdbcUrl("jdbc:h2:mem:activiti-reboot-test;DB_CLOSE_DELAY=1000").setAsyncExecutorActivate(false).buildProcessEngine();
    ...
    public void testDeployRevisedProcessAfterDeleteOnOtherProcessEngine() {
        ...
        ProcessEngine processEngine1 = new StandaloneProcessEngineConfiguration().setEngineName("reboot-test-schema")
                .setDatabaseSchemaUpdate(mobius.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_TRUE).setJdbcUrl("jdbc:h2:mem:activiti-process-cache-test;DB_CLOSE_DELAY=1000")
        ...
        ProcessEngine processEngine2 = new StandaloneProcessEngineConfiguration().setEngineName("reboot-test")
                .setDatabaseSchemaUpdate(mobius.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_FALSE).setJdbcUrl("jdbc:h2:mem:activiti-process-cache-test;DB_CLOSE_DELAY=1000")
                .setAsyncExecutorActivate(false).buildProcessEngine();
        ...
        // process engine
        String deploymentId = repositoryService1.createDeployment().addClasspathResource("mobius/engine/test/cache/originalProcess.bpmn20.xml").deploy().getId();
        ...
        deploymentId = repositoryService1.createDeployment().addClasspathResource("mobius/engine/test/cache/revisedProcess.bpmn20.xml").deploy().getId();
