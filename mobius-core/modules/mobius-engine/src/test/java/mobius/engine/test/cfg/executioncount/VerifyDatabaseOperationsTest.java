...
import mobius.common.engine.impl.cfg.CommandExecutorImpl;
...
import mobius.engine.impl.history.AbstractHistoryManager;
import mobius.engine.impl.test.PluggableFlowableTestCase;
import mobius.engine.repository.Deployment;
import mobius.engine.test.profiler.CommandStats;
import mobius.engine.test.profiler.ConsoleLogger;
import mobius.engine.test.profiler.FlowableProfiler;
import mobius.engine.test.profiler.ProfileSession;
import mobius.engine.test.profiler.ProfilingDbSqlSessionFactory;
import mobius.engine.test.profiler.TotalExecutionTimeCommandInterceptor;
...
public class VerifyDatabaseOperationsTest extends PluggableFlowableTestCase {
    ...
    public void testAsyncJob() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertDatabaseInserts("mobius.job.service.impl.cmd.ExecuteJobCmd",
                            "HistoricActivityInstanceEntityImpl-bulk-with-3", 1L);

            assertDatabaseDeletes("mobius.job.service.impl.cmd.ExecuteJobCmd",
                            "JobEntityImpl", 1L,
    ...
    public void testOneTaskProcess() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertExecutedCommands("StartProcessInstanceCmd", "mobius.task.service.impl.TaskQueryImpl", "CompleteTaskCmd");
            ...
            // mobius.task.service.Task Query
            assertDatabaseSelects("mobius.task.service.impl.TaskQueryImpl", "selectTaskByQueryCriteria", 1L);
            assertNoInserts("mobius.task.service.impl.TaskQueryImpl");
            assertNoUpdates("mobius.task.service.impl.TaskQueryImpl");
            assertNoDeletes("mobius.task.service.impl.TaskQueryImpl");

            // mobius.task.service.Task Complete

            assertDatabaseSelects("CompleteTaskCmd",
                    "selectById mobius.engine.impl.persistence.entity.HistoricProcessInstanceEntityImpl", 1L,
                    "selectById mobius.task.service.impl.persistence.entity.HistoricTaskInstanceEntityImpl", 1L,
                    "selectById mobius.task.service.impl.persistence.entity.TaskEntityImpl", 1L,
                    "selectById mobius.engine.impl.persistence.entity.ExecutionEntityImpl", 1L,
                    "selectById mobius.engine.impl.persistence.entity.HistoricActivityInstanceEntityImpl", 1L,
            ...
            assertDatabaseUpdates("CompleteTaskCmd", "mobius.task.service.impl.persistence.entity.HistoricTaskInstanceEntityImpl", 1L,
                    "mobius.engine.impl.persistence.entity.ExecutionEntityImpl", 2L,
                    "mobius.engine.impl.persistence.entity.HistoricActivityInstanceEntityImpl", 1L,
                    "mobius.engine.impl.persistence.entity.HistoricProcessInstanceEntityImpl", 1L);
    ...
    public void testRemoveTaskVariables() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertExecutedCommands("StartProcessInstanceCmd", "mobius.task.service.impl.TaskQueryImpl", "SetTaskVariablesCmd", "RemoveTaskVariablesCmd",
                    "CompleteTaskCmd");
    ...
    public void testClaimTask() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertExecutedCommands("StartProcessInstanceCmd", "mobius.task.service.impl.TaskQueryImpl", "ClaimTaskCmd", "CompleteTaskCmd");
    ...
    public void testTaskCandidateUsers() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertExecutedCommands("StartProcessInstanceCmd", "mobius.task.service.impl.TaskQueryImpl", "AddIdentityLinkCmd", "DeleteIdentityLinkCmd",
                    "CompleteTaskCmd");
            ...
            assertDatabaseSelects("AddIdentityLinkCmd", 
                    "selectById mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L,
                    "selectById mobius.engine.impl.persistence.entity.ExecutionEntityImpl", 2L,
            ...
            assertDatabaseUpdates("AddIdentityLinkCmd", 
                    "mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L);
            ...
            assertDatabaseSelects("DeleteIdentityLinkCmd", "selectById mobius.task.service.impl.persistence.entity.TaskEntityImpl", 5L,
                    "selectIdentityLinkByTaskUserGroupAndType", 5L, 
                    "selectById mobius.identitylink.service.impl.persistence.entity.HistoricIdentityLinkEntityImpl", 2L,
                    "selectIdentityLinksByTaskId", 5L);
            assertDatabaseUpdates("DeleteIdentityLinkCmd", "mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L);
        }
    }
    ...
    public void testTaskCandidateGroups() {
        if (!processEngineConfiguration.isAsyncHistoryEnabled()) {
            ...
            assertDatabaseSelects("AddIdentityLinkCmd", "selectById mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L, "selectIdentityLinksByTaskId", 2L);
            assertDatabaseUpdates("AddIdentityLinkCmd", "mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L);
            ...
            assertDatabaseSelects("DeleteIdentityLinkCmd", 
                    "selectById mobius.task.service.impl.persistence.entity.TaskEntityImpl", 5L,
                    "selectIdentityLinkByTaskUserGroupAndType", 5L, 
                    "selectById mobius.identitylink.service.impl.persistence.entity.HistoricIdentityLinkEntityImpl", 2L,
                    "selectIdentityLinksByTaskId", 5L);
            assertDatabaseUpdates("DeleteIdentityLinkCmd", "mobius.task.service.impl.persistence.entity.TaskEntityImpl", 2L);
   ...
   private Map<String, Object> createVariables(long count, String prefix) {
    ...
    protected CommandStats getStatsForCommand(String commandClass, Map<String, CommandStats> allStats) {
        ...
        if (!clazz.startsWith("mobius")) {
            clazz = "mobius.engine.impl.cmd." + clazz;
        }
    ...
    protected void deploy(String path) {
        repositoryService.createDeployment().addClasspathResource("mobius/engine/test/cfg/executioncount/" + path).deploy();
    }
    ...
    protected String getQualifiedClassName(String className) {
        if (className.startsWith("VariableInstanceEntityImpl") || className.startsWith("HistoricVariableInstanceEntityImpl")) {
            return "mobius.variable.service.impl.persistence.entity." + className;
