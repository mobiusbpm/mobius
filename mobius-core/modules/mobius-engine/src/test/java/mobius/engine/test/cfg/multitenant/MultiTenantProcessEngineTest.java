...
package mobius.engine.test.cfg.multitenant;
...
import mobius.engine.impl.cfg.multitenant.MultiSchemaMultiTenantProcessEngineConfiguration;
import mobius.engine.repository.Deployment;
import mobius.engine.runtime.ProcessInstance;
import mobius.job.service.impl.asyncexecutor.multitenant.ExecutorPerTenantAsyncExecutor;
import mobius.job.service.impl.asyncexecutor.multitenant.SharedExecutorServiceAsyncExecutor;
...
public class MultiTenantProcessEngineTest {
    ...
    private void startProcessInstances(String userId) {
        ...
        Deployment deployment = processEngine.getRepositoryService().createDeployment()
                .addClasspathResource("mobius/engine/test/cfg/multitenant/oneTaskProcess.bpmn20.xml")
                .addClasspathResource("mobius/engine/test/cfg/multitenant/jobTest.bpmn20.xml")
                .deploy();
