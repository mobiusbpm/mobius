...
public class HistoricProcessInstanceTest extends PluggableFlowableTestCase {
    ...
    /*
     * @Test
     * @Deployment(resources = {"mobius/engine/test/history/oneTaskProcess.bpmn20.xml"}) public void testHistoricProcessInstanceVariables() { Map<String,Object> vars = new
     ...
     */
    @Test
    @Deployment(resources = { "mobius/engine/test/history/HistoricProcessInstanceTest.testDeleteHistoricProcessInstanceWithCallActivity.bpmn20.xml",
            "mobius/engine/test/history/HistoricProcessInstanceTest.testDeleteHistoricProcessInstanceWithCallActivity-subprocess.bpmn20.xml" })
    ...
    public void testNameAndTenantIdSetWhenFetchingVariables() {
        ...
        String deploymentId = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/history/oneTaskProcess.bpmn20.xml").tenantId(tenantId).deploy().getId();
