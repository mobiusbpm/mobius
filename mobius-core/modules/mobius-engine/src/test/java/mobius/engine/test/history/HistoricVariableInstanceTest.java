...
public class HistoricVariableInstanceTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/engine/test/history/HistoricVariableInstanceTest.testCallSimpleSubProcess.bpmn20.xml", "mobius/engine/test/history/simpleSubProcess.bpmn20.xml" })
    ...
    @Deployment(resources = {
            "mobius/engine/test/api/runtime/variableScope.bpmn20.xml"
    })
    ...
    @Test
    @Deployment(resources = "mobius/engine/test/history/HistoricVariableInstanceTest.testSimple.bpmn20.xml")
