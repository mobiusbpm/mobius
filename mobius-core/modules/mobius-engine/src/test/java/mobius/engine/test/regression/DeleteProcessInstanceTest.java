...
public class DeleteProcessInstanceTest extends PluggableFlowableTestCase {
    ...
    public void testNoEndTimeSet() {
        ...
        // Note that the instance with a mobius.task.service.Task Type of "user" is being started.
        LOGGER.info("Starting an instance of \"Demo Partial Deletion\" with a mobius.task.service.Task Type of \"user\".");
        ...
        if (HistoryTestHelper.isHistoryLevelAtLeast(HistoryLevel.ACTIVITY, processEngineConfiguration)) {
            ...
            LOGGER.info("End time for the deleted instance of \"Demo Partial Deletion\" that was started with a mobius.task.service.Task Type of \"user\": {}.", hInstanceUser.getEndTime());
            LOGGER.info("Successfully deleted the instance of \"Demo Partial Deletion\" that was started with a mobius.task.service.Task Type of \"user\".");
        }

        // Note that the instance with a mobius.task.service.Task Type of "java" is being started.
        LOGGER.info("Starting an instance of \"Demo Partial Deletion\" with a mobius.task.service.Task Type of \"java\".");
