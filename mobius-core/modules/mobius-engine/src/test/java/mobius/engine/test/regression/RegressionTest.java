...
public class RegressionTest extends PluggableFlowableTestCase {
    ...
    public void testAct1623() throws Exception {
        ...
        // Deploy processes
        String deploymentId = repositoryService.createDeployment().addClasspathResource("mobius/engine/test/regression/act1623-processOne.bpmn")
                .addClasspathResource("mobius/engine/test/regression/act1623-processTwo.bpmn").deploy().getId();
