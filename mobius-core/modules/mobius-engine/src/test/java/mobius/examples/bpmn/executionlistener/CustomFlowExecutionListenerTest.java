...
public class CustomFlowExecutionListenerTest extends ResourceFlowableTestCase {
    ...
    public CustomFlowExecutionListenerTest() {
        super("mobius/examples/bpmn/executionlistener/custom.flow.parse.handler.flowable.cfg.xml");
    }

    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/CustomFlowExecutionListenerTest.bpmn20.xml" })
