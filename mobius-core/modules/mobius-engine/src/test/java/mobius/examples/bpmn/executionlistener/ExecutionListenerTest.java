...
import mobius.examples.bpmn.executionlistener.CurrentActivityExecutionListener.CurrentActivity;
import mobius.examples.bpmn.executionlistener.RecorderExecutionListener.RecordedEvent;
...
public class ExecutionListenerTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/ExecutionListenersProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/ExecutionListenersStartEndEvent.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/ExecutionListenersFieldInjectionProcess.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/ExecutionListenersCurrentActivity.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/executionlistener/ExecutionListenersForSubprocessStartEndEvent.bpmn20.xml" })
