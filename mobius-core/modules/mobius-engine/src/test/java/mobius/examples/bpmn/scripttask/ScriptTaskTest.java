 ...
 */
package mobius.examples.bpmn.scripttask;
    ...
    public void testNoScriptProvided() {
        try {
            deploymentIdsForAutoCleanup.add(
                repositoryService.createDeployment().addClasspathResource("mobius/examples/bpmn/scripttask/ScriptTaskTest.testNoScriptProvided.bpmn20.xml").deploy().getId()
            );
