...
package mobius.examples.bpmn.subprocess;
...
public class SubProcessTest extends PluggableFlowableTestCase {
    ...
    public void testSimpleSubProcess() {
        ...
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("mobius/examples/bpmn/subprocess/SubProcessTest.fixSystemFailureProcess.bpmn20.xml").deploy();
