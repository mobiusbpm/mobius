...
public class TaskListenerTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/tasklistener/TaskListenerTest.bpmn20.xml" })
    public void testTaskCreateListener() {
        ...
        // 3. The TaskAllEventsListener will set a variable on the mobius.task.service.Task
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/tasklistener/TaskListenerInSubProcessTest.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/bpmn/tasklistener/TaskListenerTest.testTaskListenersOnDelete.bpmn20.xml" })
