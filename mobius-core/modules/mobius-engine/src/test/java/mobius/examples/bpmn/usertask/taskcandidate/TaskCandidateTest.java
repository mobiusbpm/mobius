 ...
 */
package mobius.examples.bpmn.usertask.taskcandidate;
...
public class TaskCandidateTest extends PluggableFlowableTestCase {
    ...
    public void testSingleCandidateGroup() {
        ...
        // mobius.task.service.Task should not yet be assigned to kermit
    ...
    public void testMultipleCandidateGroups() {
        ...
        // mobius.task.service.Task should not yet be assigned to anyone
        List<Task> tasks = taskService.createTaskQuery().taskAssignee(KERMIT).list();
