 ...
 */
package mobius.examples.variables;
...
public class VariablesTest extends PluggableFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/examples/variables/VariablesTest.testChangeTypeSerializable.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/examples/variables/VariablesTest.testBasicVariableOperations.bpmn20.xml" })
    ...
    public void testNullVariable() {
        ...
        try {
            ...
            assertEquals("class mobius.common.engine.api.FlowableException", e.getClass().toString());
        }
