...
import mobius.engine.test.api.event.StaticTestFlowableEventListener;
...
public class ProcessDefinitionScopedEventListenerDefinitionTest extends ResourceFlowableTestCase {
    ...
    public void testProcessDefinitionListenerDefinitionError() throws Exception {
        ...
        mobius.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource("mobius/standalone/event/invalidEventListenerExpression.bpmn20.xml").deploy();
        ...
        deployment = repositoryService.createDeployment().addClasspathResource("mobius/standalone/event/invalidEventListenerClass.bpmn20.xml").deploy();
    ...
    public void testProcessDefinitionListenerDefinitionIllegalType() throws Exception {
        ...
        mobius.engine.repository.Deployment deployment = null;
        try {

            deployment = repositoryService.createDeployment().addClasspathResource("mobius/standalone/event/invalidEventListenerType.bpmn20.xml").deploy();
