...
import mobius.engine.test.api.runtime.DummySerializable;
import mobius.engine.test.history.SerializableVariable;
import mobius.task.api.Task;
import mobius.standalone.jpa.FieldAccessJPAEntity;
...
public class FullHistoryTest extends ResourceFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/standalone/history/FullHistoryTest.testVariableUpdates.bpmn20.xml")
    ...
    public void testHistoricFormPropertiesOnReEnteringActivity() {
        ...
        // mobius.task.service.Task should be active in the same activity as the previous one
    ...
    @Test
    @Deployment(resources = { "mobius/standalone/history/FullHistoryTest.testHistoricProcessInstanceVariableValueEquals.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/standalone/history/FullHistoryTest.testVariableUpdatesAreLinkedToActivity.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/standalone/jpa/JPAVariableTest.testQueryJPAVariable.bpmn20.xml" })
