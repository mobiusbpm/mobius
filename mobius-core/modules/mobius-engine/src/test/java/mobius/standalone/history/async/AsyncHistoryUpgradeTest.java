 ...
 */
package mobius.standalone.history.async;
...
public class AsyncHistoryUpgradeTest extends CustomConfigurationFlowableTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/standalone/history/async/AsyncHistoryTest.testSimpleStraightThroughProcess.bpmn")
    ...
    protected void downgradeHistoryJobConfigurations() {
        managementService.executeCommand(commandContext -> {
            try {
                ...
                mobius.job.service.impl.util.CommandContextUtil.getHistoryJobEntityManager(commandContext).update((HistoryJobEntity) historyJob);
            } catch (IOException e) {
