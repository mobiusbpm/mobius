 ...
 */
package mobius.standalone.initialization;
...
import mobius.common.engine.api.FlowableWrongDbException;
...
public class ProcessEngineInitializationTest extends AbstractTestCase {
    ...
    public void testNoTables() {
        try {
            ProcessEngineConfiguration.createProcessEngineConfigurationFromResource("mobius/standalone/initialization/notables.flowable.cfg.xml").buildProcessEngine();
    ...
    public void testVersionMismatch() {
        ...
        ProcessEngineImpl processEngine = (ProcessEngineImpl) ProcessEngineConfiguration.createProcessEngineConfigurationFromResource("mobius/standalone/initialization/notables.flowable.cfg.xml")
        ...
        try {
            ...
            ProcessEngineConfiguration.createProcessEngineConfigurationFromResource("mobius/standalone/initialization/notables.flowable.cfg.xml")
