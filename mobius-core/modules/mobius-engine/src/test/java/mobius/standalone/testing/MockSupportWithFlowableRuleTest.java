...
import mobius.engine.test.mock.MockServiceTasks;
...
public class MockSupportWithFlowableRuleTest {
    ...
    public FlowableRule flowableRule = new FlowableRule() {
        ...
        protected void configureProcessEngine() {
            ...
            flowableRule.mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate", "mobius.standalone.testing.helpers.ServiceTaskTestMock");
        }
    ...
    @Test
    @Deployment
    @MockServiceTask(originalClassName = "com.yourcompany.delegate", mockedClassName = "mobius.standalone.testing.helpers.ServiceTaskTestMock")
    ...
    @Test
    @Deployment(resources = { "mobius/standalone/testing/MockSupportWithFlowableRuleTest.testMockedServiceTaskAnnotation.bpmn20.xml" })
    ...
    @Test
    @Deployment
    @MockServiceTasks({ @MockServiceTask(originalClassName = "com.yourcompany.delegate1", mockedClassName = "mobius.standalone.testing.helpers.ServiceTaskTestMock"),
    ...
    @Test
    @Deployment(resources = { "mobius/standalone/testing/MockSupportWithFlowableRuleTest.testNoOpServiceTasksAnnotation.bpmn20.xml" })
