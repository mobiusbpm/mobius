...
public class MockSupportWithFlowableTestCaseTest extends FlowableTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate", "mobius.standalone.testing.helpers.ServiceTaskTestMock");
    }
    ...
    @Deployment(resources = { "mobius/standalone/testing/MockSupportWithFlowableTestCaseTest.testMockedServiceTaskAnnotation.bpmn20.xml" })
    ...
    @Deployment(resources = { "mobius/standalone/testing/MockSupportWithFlowableTestCaseTest.testNoOpServiceTasksAnnotation.bpmn20.xml" })
