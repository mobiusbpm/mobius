...
import mobius.engine.test.util.TestProcessUtil;
...
import mobius.validation.validator.ValidatorSetNames;
...
public class DefaultProcessValidatorTest {
    ...
    public void verifyValidation() throws Exception {
        ...
        InputStream xmlStream = this.getClass().getClassLoader().getResourceAsStream("mobius/engine/test/validation/invalidProcess.bpmn20.xml");
    ...
    public void testAllNonExecutableProcesses() {
        ...
        for (int i = 0; i < 5; i++) {
            mobius.bpmn.model.Process process = TestProcessUtil.createOneTaskProcess();
