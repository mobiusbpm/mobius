...
import mobius.engine.test.ConfigurationResource;
...
public class ProcessWithFormTest {
    ...
    protected static final String ONE_TASK_PROCESS = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        ...
        + "      <extensionElements>\n"
        + "        <flowable:executionListener event=\"start\" class=\"mobius.form.engine.test.SideEffectExecutionListener\"></flowable:executionListener>\n"
        + "        <flowable:executionListener event=\"end\" class=\"mobius.form.engine.test.SideEffectExecutionListener\"></flowable:executionListener>\n"
        + "      </extensionElements>\n"
        + "    </userTask>\n"
        + "\n"
