...
import mobius.http.bpmn.HttpServiceTaskTestServer.HttpServiceTaskTestServlet;
...
public class HttpServiceTaskTest extends HttpServiceTaskTestCase {
    ...
    @Test
    @Deployment(resources = "mobius/http/bpmn/HttpServiceTaskTest.testRequestTimeout2.bpmn20.xml")
    ...
    @Test
    @Deployment(resources = "mobius/http/bpmn/HttpServiceTaskTest.testRequestTimeout3.bpmn20.xml")
