...
import mobius.idm.engine.impl.IdmEngineImpl;
import mobius.idm.engine.impl.IdmIdentityServiceImpl;
import mobius.idm.engine.impl.IdmManagementServiceImpl;
import mobius.idm.engine.impl.SchemaOperationsIdmEngineBuild;
import mobius.idm.engine.impl.authentication.BlankSalt;
import mobius.idm.engine.impl.authentication.ClearTextPasswordEncoder;
import mobius.idm.engine.impl.cfg.StandaloneIdmEngineConfiguration;
import mobius.idm.engine.impl.cfg.StandaloneInMemIdmEngineConfiguration;
import mobius.idm.engine.impl.db.EntityDependencyOrder;
import mobius.idm.engine.impl.db.IdmDbSchemaManager;
import mobius.idm.engine.impl.persistence.entity.ByteArrayEntityManager;
import mobius.idm.engine.impl.persistence.entity.ByteArrayEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.GroupEntityManager;
import mobius.idm.engine.impl.persistence.entity.GroupEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.IdentityInfoEntityManager;
import mobius.idm.engine.impl.persistence.entity.IdentityInfoEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.MembershipEntityManager;
import mobius.idm.engine.impl.persistence.entity.MembershipEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.PrivilegeEntityManager;
import mobius.idm.engine.impl.persistence.entity.PrivilegeEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.PrivilegeMappingEntityManager;
import mobius.idm.engine.impl.persistence.entity.PrivilegeMappingEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.PropertyEntityManager;
import mobius.idm.engine.impl.persistence.entity.PropertyEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.TableDataManager;
import mobius.idm.engine.impl.persistence.entity.TableDataManagerImpl;
import mobius.idm.engine.impl.persistence.entity.TokenEntityManager;
import mobius.idm.engine.impl.persistence.entity.TokenEntityManagerImpl;
import mobius.idm.engine.impl.persistence.entity.UserEntityManager;
import mobius.idm.engine.impl.persistence.entity.UserEntityManagerImpl;
...
import mobius.idm.engine.impl.persistence.entity.data.PrivilegeMappingDataManager;
...
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisByteArrayDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisGroupDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisIdentityInfoDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisMembershipDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisPrivilegeDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisPrivilegeMappingDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisPropertyDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisTokenDataManager;
import mobius.idm.engine.impl.persistence.entity.data.impl.MybatisUserDataManager;

public class IdmEngineConfiguration extends AbstractEngineConfiguration implements IdmEngineConfigurationApi {

    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "mobius/idm/db/mapping/mappings.xml";
