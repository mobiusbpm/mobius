...
import mobius.idm.engine.impl.TablePageQueryImpl;
...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
    ...
    protected long getTableCount(String tableName) {
        ...
        Long count = (Long) getDbSqlSession().selectOne("mobius.idm.engine.impl.TablePageMap.selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
