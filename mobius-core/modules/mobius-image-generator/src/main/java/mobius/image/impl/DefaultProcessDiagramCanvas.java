...
import mobius.bpmn.model.AssociationDirection;
import mobius.bpmn.model.GraphicInfo;
import mobius.image.exception.FlowableImageException;
import mobius.image.util.ReflectUtil;
...
public class DefaultProcessDiagramCanvas {
    ...
    public void initialize(String imageType) {
        ...
        try {
            USERTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/userTask.png", customClassLoader));
            SCRIPTTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/scriptTask.png", customClassLoader));
            SERVICETASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/serviceTask.png", customClassLoader));
            RECEIVETASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/receiveTask.png", customClassLoader));
            SENDTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/sendTask.png", customClassLoader));
            MANUALTASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/manualTask.png", customClassLoader));
            BUSINESS_RULE_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/businessRuleTask.png", customClassLoader));
            SHELL_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/shellTask.png", customClassLoader));
            DMN_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/dmnTask.png", customClassLoader));
            CAMEL_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/camelTask.png", customClassLoader));
            MULE_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/muleTask.png", customClassLoader));
            HTTP_TASK_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/httpTask.png", customClassLoader));

            TIMER_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/timer.png", customClassLoader));
            COMPENSATE_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/compensate-throw.png", customClassLoader));
            COMPENSATE_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/compensate.png", customClassLoader));
            CONDITIONAL_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/conditional.png", customClassLoader));
            ERROR_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/error-throw.png", customClassLoader));
            ERROR_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/error.png", customClassLoader));
            ESCALATION_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/escalation-throw.png", customClassLoader));
            ESCALATION_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/escalation.png", customClassLoader));
            MESSAGE_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/message-throw.png", customClassLoader));
            MESSAGE_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/message.png", customClassLoader));
            SIGNAL_THROW_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/signal-throw.png", customClassLoader));
            SIGNAL_CATCH_IMAGE = ImageIO.read(ReflectUtil.getResource("mobius/icons/signal.png", customClassLoader));
