 ...
 */
package mobius.test.spring.executor.jms;
...
import mobius.job.service.impl.asyncexecutor.DefaultAsyncJobExecutor;
import mobius.spring.impl.test.CleanTestExecutionListener;
import mobius.test.spring.executor.jms.config.SpringJmsConfig;
...
public class SpringJmsTest {
    ...
    public void testMessageQueueAsyncExecutor() {
        processEngine.getRepositoryService().createDeployment()
                .addClasspathResource("mobius/test/spring/executor/jms/SpringJmsTest.testMessageQueueAsyncExecutor.bpmn20.xml")
                .deploy();
