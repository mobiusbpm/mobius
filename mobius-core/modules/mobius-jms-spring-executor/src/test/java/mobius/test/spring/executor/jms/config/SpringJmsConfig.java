 ...
 */
package mobius.test.spring.executor.jms.config;
...
import mobius.spring.executor.jms.JobMessageListener;
import mobius.spring.executor.jms.MessageBasedJobManager;
...
public class SpringJmsConfig {
    ...
    public JobMessageListener jobMessageListener() {
        ...
        JobServiceConfiguration jobServiceConfiguration = (JobServiceConfiguration) processEngineConfiguration.getServiceConfigurations().get(
