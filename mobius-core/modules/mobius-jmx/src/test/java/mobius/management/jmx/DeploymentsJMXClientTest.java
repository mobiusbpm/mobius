...
import mobius.management.jmx.Utils;
...
public class DeploymentsJMXClientTest {
    ...
    public void testDeploymentsJmxClient() throws Exception {
        ...
        ObjectName deploymentsBeanName = new ObjectName("mobius.jmx.Mbeans:type=Deployments");
        ...
        URL fileName = Thread.currentThread().getContextClassLoader().getResource("mobius/management/jmx/trivialProcess.bpmn");
