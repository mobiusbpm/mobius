 ...
 * 
 * @see mobius.spring.ApplicationContextElResolver
 * @author Prabhat_Tripathi
 * 
 *         blueprint context declaration syntax: <bean id="blueprintContextELResolver" class="mobius.osgi.blueprint.BlueprintContextELResolver">
