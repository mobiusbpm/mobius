...
public abstract class ExternalInvocationTaskValidator extends ProcessLevelValidator {
    ...
    protected void validateFieldDeclarationsForEmail(mobius.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForShell(mobius.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForDmn(mobius.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForHttp(mobius.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForCase(mobius.bpmn.model.Process process, CaseServiceTask caseServiceTask, List<ValidationError> errors) {
