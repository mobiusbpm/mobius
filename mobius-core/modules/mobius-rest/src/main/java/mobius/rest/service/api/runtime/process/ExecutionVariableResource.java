...
public class ExecutionVariableResource extends BaseExecutionVariableResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "body", type = "mobius.rest.rest.service.api.engine.variable.RestVariable", value = "Update a variable on an execution", paramType = "body", example = "{\n" +
                    "    \"name\":\"intProcVar\"\n" +
                    "    \"type\":\"integer\"\n" +
                    "    \"value\":123,\n" +
                    "    \"scope\":\"global\"\n" +
