...
import mobius.rest.service.api.engine.AttachmentRequest;
...
public class TaskAttachmentCollectionResource extends TaskBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "body", type = "mobius.rest.rest.service.api.engine.AttachmentRequest", value = "create an attachment containing a link to an external resource", paramType = "body", example = "{\n" + "  \"name\":\"Simple attachment\",\n" + "  \"description\":\"Simple attachment description\",\n"
