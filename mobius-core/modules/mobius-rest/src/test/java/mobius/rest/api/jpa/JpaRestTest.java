...
import mobius.rest.api.jpa.model.Message;
import mobius.rest.api.jpa.repository.MessageRepository;
...
public class JpaRestTest extends BaseJPARestTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/rest/api/jpa/jpa-process.bpmn20.xml" })
