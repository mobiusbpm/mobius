...
public class DeploymentResourceTest extends BaseSpringRestTestCase {
    ...
    public void testPostNewDeploymentBPMNFile() throws Exception {
        try {
            ...
            httpPost.setEntity(HttpMultipartHelper.getMultiPartEntity("oneTaskProcess.bpmn20.xml", "application/xml",
                    ReflectUtil.getResourceAsStream("mobius/rest/service/api/repository/oneTaskProcess.bpmn20.xml"), null));
    ...
    public void testPostNewDeploymentBarFile() throws Exception {
        try {
            ...
            IOUtils.copy(ReflectUtil.getResourceAsStream("mobius/rest/service/api/repository/oneTaskProcess.bpmn20.xml"), zipStream);
     ...
     */
    @Test
    @mobius.engine.test.Deployment(resources = { "mobius/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
