...
public class ProcessDefinitionCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetProcessDefinitions() throws Exception {
        ...
        try {
            Deployment firstDeployment = repositoryService.createDeployment().name("Deployment 1").addClasspathResource("mobius/rest/service/api/repository/oneTaskProcess.bpmn20.xml").deploy();

            Deployment secondDeployment = repositoryService.createDeployment().name("Deployment 2").addClasspathResource("mobius/rest/service/api/repository/oneTaskProcess.bpmn20.xml")
                    .addClasspathResource("mobius/rest/service/api/repository/twoTaskProcess.bpmn20.xml").deploy();

            Deployment thirdDeployment = repositoryService.createDeployment().name("Deployment 3").addClasspathResource("mobius/rest/service/api/repository/oneTaskProcessWithDi.bpmn20.xml").deploy();
            ...
            url = baseUrl + "?resourceName=mobius/rest/service/api/repository/twoTaskProcess.bpmn20.xml";
            assertResultsPresentInDataResponse(url, twoTaskprocess.getId());
