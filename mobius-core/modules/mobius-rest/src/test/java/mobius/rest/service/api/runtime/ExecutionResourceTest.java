...
public class ExecutionResourceTest extends BaseSpringRestTestCase {
     ...
     */
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ExecutionResourceTest.process-with-subprocess.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ExecutionResourceTest.process-with-signal.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ExecutionResourceTest.process-with-signal-event.bpmn20.xml" })
     ...
     */
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ExecutionResourceTest.process-with-message-event.bpmn20.xml" })
