...
public class ProcessInstanceCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ProcessInstanceResourceTest.process-one.bpmn20.xml" })
    ...
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ProcessInstanceResourceTest.process-with-form.bpmn20.xml",
                    "mobius/rest/service/api/runtime/simple.form"})
    ...
    @Test
    @Deployment(resources = { "mobius/rest/service/api/oneTaskProcess.bpmn20.xml" })
    public void testStartProcessUsingKeyAndTenantId() throws Exception {
        mobius.engine.repository.Deployment tenantDeployment = null;

        try {
            // Deploy the same process, in another tenant
            tenantDeployment = repositoryService.createDeployment().addClasspathResource("mobius/rest/service/api/oneTaskProcess.bpmn20.xml").tenantId("tenant1").deploy();
