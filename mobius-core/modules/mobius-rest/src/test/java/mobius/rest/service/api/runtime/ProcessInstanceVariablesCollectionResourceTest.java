...
public class ProcessInstanceVariablesCollectionResourceTest extends BaseSpringRestTestCase {
     ...
     */
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    public void testCreateSingleBinaryProcessVariable() throws Exception {
        ...
        httpPost.setEntity(HttpMultipartHelper
				.getMultiPartEntity("value", "application/octet-stream", binaryContent, additionalFields));
