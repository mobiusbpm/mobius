...
public class SignalsResourceTest extends BaseSpringRestTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/rest/service/api/runtime/SignalsResourceTest.process-signal-start.bpmn20.xml" })
    public void testSignalEventReceivedSync() throws Exception {

        mobius.engine.repository.Deployment tenantDeployment = repositoryService.createDeployment()
                .addClasspathResource("mobius/rest/service/api/runtime/SignalsResourceTest.process-signal-start.bpmn20.xml").tenantId("my tenant").deploy();
