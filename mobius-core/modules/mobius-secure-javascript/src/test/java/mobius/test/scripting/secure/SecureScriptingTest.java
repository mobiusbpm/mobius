 ...
 */
package mobius.test.scripting.secure;
...
public class SecureScriptingTest extends SecureScriptingBaseTest {
    ...
    public void testUseExecutionAndVariables() {
        ...
        addWhiteListedClass("mobius.engine.impl.persistence.entity.ExecutionEntityImpl");
    ...
    public void testExecutionListener2() throws Exception {
        ...
        removeWhiteListedClass("mobius.engine.impl.persistence.entity.ExecutionEntityImpl");
        try {
            runtimeService.startProcessInstanceByKey("secureScripting");
            Assert.fail(); // Expecting exception
        } catch (Exception e) {
