...
public class FlowableProperties {
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.idm.FlowableIdmProperties#enabled}
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.process.FlowableProcessProperties#getServlet()#getPath()}
     */
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.process.FlowableProcessProperties#getServlet()#setPath()}
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.process.FlowableProcessProperties#getServlet()#getName()}
     */
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.process.FlowableProcessProperties#getServlet()#setName()}
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.idm.FlowableIdmProperties#isEnabled()}
     */
    ...
    /**
     * @deprecated use {@link mobius.spring.boot.idm.FlowableIdmProperties#setEnabled(boolean)}
     */
    @Deprecated
