 ...
 */
package mobius.spring.boot.ldap;
...
import mobius.ldap.LDAPConfiguration;
...
public class FlowableLdapProperties {
    ...
    public static class Query {
         ...
         * {@link mobius.ldap.LDAPQueryBuilder}, which allows for more customization than only the query.
         */
    ...
    public static class Attribute {
         ...
         * <p>
         * This property is used when looking for a {@link mobius.idm.api.User} object and the mapping between the LDAP object and the Flowable
         * {@link mobius.idm.api.User} object is done.
         * <p>
         * This property is optional and is only needed if searching for {@link mobius.idm.api.User} objects using the Flowable API.
         */
         ...
         * <p>
         * This property is used when looking for a {@link mobius.idm.api.Group} object and the mapping between the LDAP object and the Flowable
         * {@link mobius.idm.api.Group} object is done.
         */
    ...
    public static class Cache {
        ...
        /**
         * Allows to set the size of the {@link mobius.ldap.LDAPGroupCache}. This is an LRU cache that caches groups for users and thus avoids hitting
         ...
         * <p>
         * Note that the group cache is instantiated on the {@link mobius.ldap.LDAPIdentityServiceImpl}. As such, if you have a custom implementation of
         * the {@link mobius.ldap.LDAPIdentityServiceImpl}, do not forget to add the group cache functionality.
         */
        private int groupSize = -1;

        /**
         * Sets the expiration time of the {@link mobius.ldap.LDAPGroupCache} in milliseconds. When groups for a specific user are fetched, and if the
