package mobius.spring.boot.ldap;/* Licensed under the Apache License, Version 2.0 (the "License");
...
public class FlowableLdapPropertiesTest {
    ...
    public void shouldCorrectlyCustomizeLdapConfiguration() {
        ...
        properties.setBaseDn("mobius");
        properties.setUserBaseDn("mobius.user");
        properties.setGroupBaseDn("mobius.group");
