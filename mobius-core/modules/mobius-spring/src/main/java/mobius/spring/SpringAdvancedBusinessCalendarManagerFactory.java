 ...
 * 
 * <pre>
 * &lt;bean id="businessCalendarManagerFactory" class="mobius.spring.SpringAdvancedBusinessCalendarManagerFactory" /&gt;
 * </pre>
 * 
 * Add the manager to your mobius.spring.SpringProcessEngineConfiguration bean
 * 
 * <pre>
 *  &lt;bean id="processEngineConfiguration" class="mobius.spring.SpringProcessEngineConfiguration"&gt;
 *    ...
...
public class SpringAdvancedBusinessCalendarManagerFactory {
    ...
    public BusinessCalendarManager getBusinessCalendarManager() {
        ...
        mapBusinessCalendarManager.addBusinessCalendar(
                AdvancedCycleBusinessCalendar.NAME, new AdvancedCycleBusinessCalendar(getClock(), defaultScheduleVersion));
