 ...
 * 
 * @author Pablo Ganga
 * @deprecated use {@link mobius.spring.job.service.SpringAsyncExecutor}
 */
@Deprecated
public class SpringAsyncExecutor extends mobius.spring.job.service.SpringAsyncExecutor {
     ...
     * @deprecated use {@link this#setRejectedJobsHandler(mobius.spring.job.service.SpringRejectedJobsHandler)}
     */
    @Deprecated
