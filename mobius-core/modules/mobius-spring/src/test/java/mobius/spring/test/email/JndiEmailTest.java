 ...
 */
package mobius.spring.test.email;
...
@ContextConfiguration("classpath:mobius/spring/test/email/jndiEmailConfiguaration-context.xml")
public class JndiEmailTest extends SpringFlowableTestCase {
    ...
    @Test
    @Deployment(resources = { "mobius/spring/test/email/EmailTaskUsingJndi.bpmn20.xml" })
