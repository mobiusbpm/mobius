 ...
 */
package mobius.spring.test.executionListener;
 ...
 * @author Yvo Swillens
 */
@ContextConfiguration("classpath:mobius/spring/test/executionListener/TransactionDependentListenerTest-context.xml")
