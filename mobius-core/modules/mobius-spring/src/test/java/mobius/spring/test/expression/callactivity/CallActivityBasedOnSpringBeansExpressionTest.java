 ...
 */
package mobius.spring.test.expression.callactivity;
 ...
 */
@ContextConfiguration("classpath:mobius/spring/test/expression/callactivity/testCallActivityByExpression-context.xml")
public class CallActivityBasedOnSpringBeansExpressionTest extends SpringFlowableTestCase {

    @Test
    @Deployment(resources = { "mobius/spring/test/expression/callactivity/CallActivityBasedOnSpringBeansExpressionTest.testCallActivityByExpression.bpmn20.xml",
            "mobius/spring/test/expression/callactivity/simpleSubProcess.bpmn20.xml" })
