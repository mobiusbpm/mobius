 ...
 */
package mobius.spring.test.scope;
...
@ContextConfiguration("classpath:mobius/spring/test/components/ScopingTests-context.xml")
@Ignore
...
public class XmlNamespaceProcessScopeTest {
    ...
    public void before() throws Throwable {
        this.processEngine.getRepositoryService().createDeployment().addClasspathResource(
				"mobius/spring/test/components/spring-component-waiter.bpmn20.xml").deploy();
