...
import mobius.task.service.*;
import mobius.task.service.history.InternalHistoryTaskManager;
import mobius.task.service.impl.HistoricTaskServiceImpl;
import mobius.task.service.impl.TaskServiceImpl;
import mobius.task.service.impl.persistence.entity.*;
...
import mobius.task.service.impl.persistence.entity.data.TaskDataManager;
import mobius.task.service.impl.persistence.entity.data.impl.MyBatisHistoricTaskLogEntryDataManager;
import mobius.task.service.impl.persistence.entity.data.impl.MybatisHistoricTaskInstanceDataManager;
import mobius.task.service.impl.persistence.entity.data.impl.MybatisTaskDataManager;
...
public class TaskServiceConfiguration extends AbstractServiceConfiguration {
    ...
    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "mobius/task/service/db/mapping/mappings.xml";
